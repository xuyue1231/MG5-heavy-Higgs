...
C     
C     Process: d~ d > z x0 > w+ e+ e- w- WEIGHTED<=4 [ all = QCD ] / a
C     Process: s~ s > z x0 > w+ e+ e- w- WEIGHTED<=4 [ all = QCD ] / a
C     Process: d~ d > z x0 > w+ mu+ mu- w- WEIGHTED<=4 [ all = QCD ] /
C      a
C     Process: s~ s > z x0 > w+ mu+ mu- w- WEIGHTED<=4 [ all = QCD ] /
C      a
C     
      IMPLICIT NONE
C     
...
C           Amplitude(s) for diagram number 1
            CALL VVS10_1_2_13_0(W(1,7),W(1,6),W(1,2),GC_3007A
