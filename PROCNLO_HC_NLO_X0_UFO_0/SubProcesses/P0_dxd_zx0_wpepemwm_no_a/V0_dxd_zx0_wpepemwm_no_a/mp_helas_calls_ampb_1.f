...
C      if true.
      ...
      CALL MP_VXXXXX(P(0,6),MDL_MW,NHEL(6),+1*IC(6),W(1,6))
      CALL MP_FFV2_3_3(W(1,2),W(1,1),-GC_22,GC_23,MDL_MZ,MDL_WZ,W(1,7))
      CALL MP_VVS10_1_11_2_12_3(W(1,6),W(1,3),GC_3005A,GC_3005H1
...
C     Amplitude(s) for born diagram with ID 1
     ...
     $ ,GC_3007H2,GC_3007H3,MDL_MZ,MDL_WZ,W(1,10))
C     Counter-term amplitude(s) for loop diagram number 2
      CALL MP_FFV2_3_0(W(1,2),W(1,1),W(1,10),-R2_UUZ_V2,R2_UUZ_V5
     $ ,AMPL(1,1))
