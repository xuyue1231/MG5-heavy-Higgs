...
C     
C     Process: d g > w- x0 > w- e+ e- z u WEIGHTED<=5 [ all = QCD ] / a
C     Process: s g > w- x0 > w- e+ e- z c WEIGHTED<=5 [ all = QCD ] / a
C     Process: d g > w- x0 > w- mu+ mu- z u WEIGHTED<=5 [ all = QCD ]
C      / a
C     Process: s g > w- x0 > w- mu+ mu- z c WEIGHTED<=5 [ all = QCD ]
C      / a
C     
      IMPLICIT NONE
C     
