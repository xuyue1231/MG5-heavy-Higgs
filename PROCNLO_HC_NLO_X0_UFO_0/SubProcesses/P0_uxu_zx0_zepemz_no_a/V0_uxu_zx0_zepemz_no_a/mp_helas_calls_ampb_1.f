...
C     Counter-term amplitude(s) for loop diagram number 4
      CALL MP_FFV2_5_0(W(1,2),W(1,1),W(1,12),R2_UUZ_V2,R2_UUZ_V5
     $ ,AMPL(1,1))
...
C     Counter-term amplitude(s) for loop diagram number 5
      CALL MP_FFV2_5_0(W(1,2),W(1,1),W(1,14),R2_UUZ_V2,R2_UUZ_V5
     $ ,AMPL(1,2))
...
C     Counter-term amplitude(s) for loop diagram number 6
      CALL MP_FFV2_5_0(W(1,2),W(1,1),W(1,16),R2_UUZ_V2,R2_UUZ_V5
     $ ,AMPL(1,3))
