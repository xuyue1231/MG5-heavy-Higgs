...
C     Coefficient construction for loop diagram with ID 4
      ...
      CALL MP_FFV2_5L1_2(PL(0,2),W(1,12),GC_22,GC_23,ZERO,ZERO,PL(0,3)
     $ ,COEFS)
...
C     Coefficient construction for loop diagram with ID 5
      CALL MP_FFV2_5L1_2(PL(0,2),W(1,14),GC_22,GC_23,ZERO,ZERO,PL(0,4)
     $ ,COEFS)
...
C     Coefficient construction for loop diagram with ID 6
      CALL MP_FFV2_5L1_2(PL(0,2),W(1,16),GC_22,GC_23,ZERO,ZERO,PL(0,5)
     $ ,COEFS)
