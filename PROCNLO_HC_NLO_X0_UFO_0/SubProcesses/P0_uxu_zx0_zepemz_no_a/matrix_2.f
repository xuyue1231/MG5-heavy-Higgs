...
C     Process: g u > z x0 > z mu+ mu- z u WEIGHTED<=5 [ all = QCD ] / a
C     Process: g c > z x0 > z mu+ mu- z c WEIGHTED<=5 [ all = QCD ] / a
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
     ...
     $ ,GC_3007H3,MDL_MX0,MDL_WX0,W(1,9))
      ...
      CALL FFV2_5_3(W(1,8),W(1,7),GC_22,GC_23,MDL_MZ,MDL_WZ,W(1,5))
