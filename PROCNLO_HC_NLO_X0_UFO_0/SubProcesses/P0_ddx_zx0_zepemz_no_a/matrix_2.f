...
C     
C     Process: g d~ > z x0 > z e+ e- z d~ WEIGHTED<=5 [ all = QCD ] / a
C     Process: g s~ > z x0 > z e+ e- z s~ WEIGHTED<=5 [ all = QCD ] / a
C     Process: g d~ > z x0 > z mu+ mu- z d~ WEIGHTED<=5 [ all = QCD ]
C      / a
C     Process: g s~ > z x0 > z mu+ mu- z s~ WEIGHTED<=5 [ all = QCD ]
C      / a
C     
      IMPLICIT NONE
C     
...
C     ----------
     ...
     $ ,GC_3007H3,MDL_MX0,MDL_WX0,W(1,9))
      ...
      CALL FFV2_3_3(W(1,7),W(1,8),-GC_22,GC_23,MDL_MZ,MDL_WZ,W(1,5))
