...
C     Coefficient construction for loop diagram with ID 4
      ...
      CALL MP_FFV2_3L2_1(PL(0,2),W(1,12),-GC_22,GC_23,ZERO,ZERO,PL(0,3)
     $ ,COEFS)
      CALL MP_UPDATE_WL_1_1(WL(1,0,1,2),4,COEFS,4,4,WL(1,0,1,3))
      CALL MP_CREATE_LOOP_COEFS(WL(1,0,1,3),2,4,1,1,1,4,H)
C     Coefficient construction for loop diagram with ID 5
      CALL MP_FFV2_3L2_1(PL(0,2),W(1,14),-GC_22,GC_23,ZERO,ZERO,PL(0,4)
     $ ,COEFS)
      CALL MP_UPDATE_WL_1_1(WL(1,0,1,2),4,COEFS,4,4,WL(1,0,1,4))
      CALL MP_CREATE_LOOP_COEFS(WL(1,0,1,4),2,4,1,1,1,5,H)
C     Coefficient construction for loop diagram with ID 6
      CALL MP_FFV2_3L2_1(PL(0,2),W(1,16),-GC_22,GC_23,ZERO,ZERO,PL(0,5)
     $ ,COEFS)
      CALL MP_UPDATE_WL_1_1(WL(1,0,1,2),4,COEFS,4,4,WL(1,0,1,5))
      CALL MP_CREATE_LOOP_COEFS(WL(1,0,1,5),2,4,1,1,1,6,H)
