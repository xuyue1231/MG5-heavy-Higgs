...
C     
C     Process: u~ g > w- x0 > w- e+ e- z d~ WEIGHTED<=5 [ all = QCD ]
C      / a
C     Process: c~ g > w- x0 > w- e+ e- z s~ WEIGHTED<=5 [ all = QCD ]
C      / a
C     Process: u~ g > w- x0 > w- mu+ mu- z d~ WEIGHTED<=5 [ all = QCD
C      ] / a
C     Process: c~ g > w- x0 > w- mu+ mu- z s~ WEIGHTED<=5 [ all = QCD
C      ] / a
C     
      IMPLICIT NONE
C     
...
C     ----------
      ...
      CALL FFV2_3(W(1,7),W(1,8),GC_47,MDL_MW,MDL_WW,W(1,5))
