...
C     
C     Process: d~ d > z x0 > z e+ e- z QED<=2 QNP<=2 WEIGHTED<=4 [ all
C      = QCD ] / a
C     Process: s~ s > z x0 > z e+ e- z QED<=2 QNP<=2 WEIGHTED<=4 [ all
C      = QCD ] / a
C     Process: d~ d > z x0 > z mu+ mu- z QED<=2 QNP<=2 WEIGHTED<=4 [
C      all = QCD ] / a
C     Process: s~ s > z x0 > z mu+ mu- z QED<=2 QNP<=2 WEIGHTED<=4 [
C      all = QCD ] / a
C     
      IMPLICIT NONE
C     
