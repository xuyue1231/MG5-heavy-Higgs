...
C     
C     Process: u g > z x0 > w+ e+ e- w- u WEIGHTED<=5 [ all = QCD ] / a
C     Process: c g > z x0 > w+ e+ e- w- c WEIGHTED<=5 [ all = QCD ] / a
C     Process: u g > z x0 > w+ mu+ mu- w- u WEIGHTED<=5 [ all = QCD ]
C      / a
C     Process: c g > z x0 > w+ mu+ mu- w- c WEIGHTED<=5 [ all = QCD ]
C      / a
C     
      IMPLICIT NONE
C     
