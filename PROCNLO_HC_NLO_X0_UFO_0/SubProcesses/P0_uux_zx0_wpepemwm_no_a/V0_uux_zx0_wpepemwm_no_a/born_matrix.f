...
C     
C     Process: u u~ > z x0 > w+ e+ e- w- QED<=2 QNP<=2 WEIGHTED<=4 [
C      all = QCD ] / a
C     Process: c c~ > z x0 > w+ e+ e- w- QED<=2 QNP<=2 WEIGHTED<=4 [
C      all = QCD ] / a
C     Process: u u~ > z x0 > w+ mu+ mu- w- QED<=2 QNP<=2 WEIGHTED<=4 [
C      all = QCD ] / a
C     Process: c c~ > z x0 > w+ mu+ mu- w- QED<=2 QNP<=2 WEIGHTED<=4 [
C      all = QCD ] / a
C     
      IMPLICIT NONE
C     
...
C     ----------
     ...
     $ ,GC_3005H2,GC_3005H3,GC_3005H4,MDL_MX0,MDL_WX0,W(1,2))
      CALL FFV2_4_3(W(1,4),W(1,5),-GC_22,GC_24,MDL_MZ,MDL_WZ,W(1,6))
C     Amplitude(s) for diagram number 1
      CALL VVS10_1_2_13_0(W(1,7),W(1,6),W(1,2),GC_3007A,GC_3007H1
