...
C     
C     Process: g u~ > z x0 > w+ e+ e- w- u~ WEIGHTED<=5 [ all = QCD ]
C      / a
C     Process: g c~ > z x0 > w+ e+ e- w- c~ WEIGHTED<=5 [ all = QCD ]
C      / a
C     Process: g u~ > z x0 > w+ mu+ mu- w- u~ WEIGHTED<=5 [ all = QCD
C      ] / a
C     Process: g c~ > z x0 > w+ mu+ mu- w- c~ WEIGHTED<=5 [ all = QCD
C      ] / a
C     
      IMPLICIT NONE
C     
