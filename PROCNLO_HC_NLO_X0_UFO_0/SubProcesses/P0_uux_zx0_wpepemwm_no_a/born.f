...
C     
C     Process: u u~ > z x0 > w+ e+ e- w- WEIGHTED<=4 [ all = QCD ] / a
C     Process: c c~ > z x0 > w+ e+ e- w- WEIGHTED<=4 [ all = QCD ] / a
C     Process: u u~ > z x0 > w+ mu+ mu- w- WEIGHTED<=4 [ all = QCD ] /
C      a
C     Process: c c~ > z x0 > w+ mu+ mu- w- WEIGHTED<=4 [ all = QCD ] /
C      a
C     
      IMPLICIT NONE
C     
