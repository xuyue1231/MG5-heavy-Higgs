...
C     
C     Process: g u~ > z x0 > z e+ e- z u~ WEIGHTED<=5 [ all = QCD ] / a
C     Process: g c~ > z x0 > z e+ e- z c~ WEIGHTED<=5 [ all = QCD ] / a
C     Process: g u~ > z x0 > z mu+ mu- z u~ WEIGHTED<=5 [ all = QCD ]
C      / a
C     Process: g c~ > z x0 > z mu+ mu- z c~ WEIGHTED<=5 [ all = QCD ]
C      / a
C     
      IMPLICIT NONE
C     
...
C     ----------
     ...
     $ ,GC_3007H3,MDL_MX0,MDL_WX0,W(1,9))
      ...
      CALL FFV2_5_3(W(1,7),W(1,8),GC_22,GC_23,MDL_MZ,MDL_WZ,W(1,5))
...
C     Amplitude(s) for diagram number 3
     ...
     $ ,GC_3007H2,GC_3007H3,AMP(3))
      CALL FFV1_2(W(1,7),W(1,1),GC_5,ZERO,ZERO,W(1,5))
