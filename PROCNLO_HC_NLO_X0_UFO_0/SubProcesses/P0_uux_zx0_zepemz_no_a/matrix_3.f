...
C     
C     Process: u g > z x0 > z e+ e- z u WEIGHTED<=5 [ all = QCD ] / a
C     Process: c g > z x0 > z e+ e- z c WEIGHTED<=5 [ all = QCD ] / a
C     Process: u g > z x0 > z mu+ mu- z u WEIGHTED<=5 [ all = QCD ] / a
C     Process: c g > z x0 > z mu+ mu- z c WEIGHTED<=5 [ all = QCD ] / a
C     
      IMPLICIT NONE
C     
C     CONSTANTS
