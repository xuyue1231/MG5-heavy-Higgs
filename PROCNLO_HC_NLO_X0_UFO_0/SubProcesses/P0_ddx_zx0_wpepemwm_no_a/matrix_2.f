...
C     
C     Process: g d~ > z x0 > w+ e+ e- w- d~ WEIGHTED<=5 [ all = QCD ]
C      / a
C     Process: g s~ > z x0 > w+ e+ e- w- s~ WEIGHTED<=5 [ all = QCD ]
C      / a
C     Process: g d~ > z x0 > w+ mu+ mu- w- d~ WEIGHTED<=5 [ all = QCD
C      ] / a
C     Process: g s~ > z x0 > w+ mu+ mu- w- s~ WEIGHTED<=5 [ all = QCD
C      ] / a
C     
      IMPLICIT NONE
C     
