...
C     
C     Process: d g > z x0 > w+ e+ e- w- d WEIGHTED<=5 [ all = QCD ] / a
C     Process: s g > z x0 > w+ e+ e- w- s WEIGHTED<=5 [ all = QCD ] / a
C     Process: d g > z x0 > w+ mu+ mu- w- d WEIGHTED<=5 [ all = QCD ]
C      / a
C     Process: s g > z x0 > w+ mu+ mu- w- s WEIGHTED<=5 [ all = QCD ]
C      / a
C     
      IMPLICIT NONE
C     
