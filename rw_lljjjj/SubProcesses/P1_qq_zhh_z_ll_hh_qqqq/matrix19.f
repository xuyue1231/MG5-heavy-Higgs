...
C     ----------
      ...
      CALL FFV2_3_3(W(1,7),W(1,3),GC_37,GC_45,MDL_MZ,MDL_WZ,W(1,9))
      CALL VVS2_3_3(W(1,8),W(1,9),GC_18,GC_17,MDL_MHH,MDL_WHH,W(1,10))
      CALL FFV2_5_3(W(1,1),W(1,2),GC_38,GC_45,MDL_MZ,MDL_WZ,W(1,11))
C     Amplitude(s) for diagram number 1
      CALL VVS2_3_0(W(1,5),W(1,11),W(1,10),GC_18,GC_17,AMP(1))
      CALL VVS1_3(W(1,8),W(1,9),GC_16,MDL_MHH,MDL_WHH,W(1,2))
C     Amplitude(s) for diagram number 2
      CALL VVS2_3_0(W(1,5),W(1,11),W(1,2),GC_18,GC_17,AMP(2))
      CALL FFV2_3_3(W(1,7),W(1,4),GC_37,GC_45,MDL_MZ,MDL_WZ,W(1,9))
      CALL FFV2_3_3(W(1,6),W(1,3),GC_37,GC_45,MDL_MZ,MDL_WZ,W(1,7))
      CALL VVS2_3_3(W(1,9),W(1,7),GC_18,GC_17,MDL_MHH,MDL_WHH,W(1,6))
C     Amplitude(s) for diagram number 3
      CALL VVS2_3_0(W(1,5),W(1,11),W(1,6),GC_18,GC_17,AMP(3))
      CALL VVS1_3(W(1,9),W(1,7),GC_16,MDL_MHH,MDL_WHH,W(1,3))
