...
C     ****************************************************
C     
C     Generated by MadGraph5_aMC@NLO v. 2.5.4, 2017-03-28
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
C     
C     Process: u u~ > z hh WEIGHTED<=4 @1
C     *   Decay: z > e- e+ WEIGHTED<=2
C     *   Decay: hh > u u u~ u~ WEIGHTED<=6
C     Process: c c~ > z hh WEIGHTED<=4 @1
C     *   Decay: z > e- e+ WEIGHTED<=2
C     *   Decay: hh > u u u~ u~ WEIGHTED<=6
C     Process: u u~ > z hh WEIGHTED<=4 @1
...
C       Flip CM_RAP (to get rapidity right)
      ...
      IF (PASSCUTS(P1)) THEN
        IF(IPROC.EQ.1) DSIGPROC=DSIG1(P1,WGT,IMODE)  ! u u~ > e- e+ u u u~ u~
        IF(IPROC.EQ.2) DSIGPROC=DSIG2(P1,WGT,IMODE)  ! u u~ > e- e+ u c u~ c~
        IF(IPROC.EQ.3) DSIGPROC=DSIG3(P1,WGT,IMODE)  ! u u~ > e- e+ u d u~ d~
        IF(IPROC.EQ.4) DSIGPROC=DSIG4(P1,WGT,IMODE)  ! u u~ > e- e+ u d u~ s~
        IF(IPROC.EQ.5) DSIGPROC=DSIG5(P1,WGT,IMODE)  ! u u~ > e- e+ u d c~ d~
        IF(IPROC.EQ.6) DSIGPROC=DSIG6(P1,WGT,IMODE)  ! u u~ > e- e+ u d c~ s~
        IF(IPROC.EQ.7) DSIGPROC=DSIG7(P1,WGT,IMODE)  ! u u~ > e- e+ u s u~ d~
        IF(IPROC.EQ.8) DSIGPROC=DSIG8(P1,WGT,IMODE)  ! u u~ > e- e+ u s u~ s~
        IF(IPROC.EQ.9) DSIGPROC=DSIG9(P1,WGT,IMODE)  ! u u~ > e- e+ u s c~ d~
        IF(IPROC.EQ.10) DSIGPROC=DSIG10(P1,WGT,IMODE)  ! u u~ > e- e+ u s c~ s~
        IF(IPROC.EQ.11) DSIGPROC=DSIG11(P1,WGT,IMODE)  ! u u~ > e- e+ c d u~ d~
        IF(IPROC.EQ.12) DSIGPROC=DSIG12(P1,WGT,IMODE)  ! u u~ > e- e+ c d u~ s~
        IF(IPROC.EQ.13) DSIGPROC=DSIG13(P1,WGT,IMODE)  ! u u~ > e- e+ c d c~ d~
        IF(IPROC.EQ.14) DSIGPROC=DSIG14(P1,WGT,IMODE)  ! u u~ > e- e+ c d c~ s~
        IF(IPROC.EQ.15) DSIGPROC=DSIG15(P1,WGT,IMODE)  ! u u~ > e- e+ c s u~ d~
        IF(IPROC.EQ.16) DSIGPROC=DSIG16(P1,WGT,IMODE)  ! u u~ > e- e+ c s u~ s~
        IF(IPROC.EQ.17) DSIGPROC=DSIG17(P1,WGT,IMODE)  ! u u~ > e- e+ c s c~ d~
        IF(IPROC.EQ.18) DSIGPROC=DSIG18(P1,WGT,IMODE)  ! u u~ > e- e+ c s c~ s~
        IF(IPROC.EQ.19) DSIGPROC=DSIG19(P1,WGT,IMODE)  ! u u~ > e- e+ d d d~ d~
        IF(IPROC.EQ.20) DSIGPROC=DSIG20(P1,WGT,IMODE)  ! u u~ > e- e+ d s d~ s~
        IF(IPROC.EQ.21) DSIGPROC=DSIG21(P1,WGT,IMODE)  ! d d~ > e- e+ u u u~ u~
        IF(IPROC.EQ.22) DSIGPROC=DSIG22(P1,WGT,IMODE)  ! d d~ > e- e+ u c u~ c~
        IF(IPROC.EQ.23) DSIGPROC=DSIG23(P1,WGT,IMODE)  ! d d~ > e- e+ u d u~ d~
        IF(IPROC.EQ.24) DSIGPROC=DSIG24(P1,WGT,IMODE)  ! d d~ > e- e+ u d u~ s~
        IF(IPROC.EQ.25) DSIGPROC=DSIG25(P1,WGT,IMODE)  ! d d~ > e- e+ u d c~ d~
        IF(IPROC.EQ.26) DSIGPROC=DSIG26(P1,WGT,IMODE)  ! d d~ > e- e+ u d c~ s~
        IF(IPROC.EQ.27) DSIGPROC=DSIG27(P1,WGT,IMODE)  ! d d~ > e- e+ u s u~ d~
        IF(IPROC.EQ.28) DSIGPROC=DSIG28(P1,WGT,IMODE)  ! d d~ > e- e+ u s u~ s~
        IF(IPROC.EQ.29) DSIGPROC=DSIG29(P1,WGT,IMODE)  ! d d~ > e- e+ u s c~ d~
        IF(IPROC.EQ.30) DSIGPROC=DSIG30(P1,WGT,IMODE)  ! d d~ > e- e+ u s c~ s~
        IF(IPROC.EQ.31) DSIGPROC=DSIG31(P1,WGT,IMODE)  ! d d~ > e- e+ c d u~ d~
        IF(IPROC.EQ.32) DSIGPROC=DSIG32(P1,WGT,IMODE)  ! d d~ > e- e+ c d u~ s~
        IF(IPROC.EQ.33) DSIGPROC=DSIG33(P1,WGT,IMODE)  ! d d~ > e- e+ c d c~ d~
        IF(IPROC.EQ.34) DSIGPROC=DSIG34(P1,WGT,IMODE)  ! d d~ > e- e+ c d c~ s~
        IF(IPROC.EQ.35) DSIGPROC=DSIG35(P1,WGT,IMODE)  ! d d~ > e- e+ c s u~ d~
        IF(IPROC.EQ.36) DSIGPROC=DSIG36(P1,WGT,IMODE)  ! d d~ > e- e+ c s u~ s~
        IF(IPROC.EQ.37) DSIGPROC=DSIG37(P1,WGT,IMODE)  ! d d~ > e- e+ c s c~ d~
        IF(IPROC.EQ.38) DSIGPROC=DSIG38(P1,WGT,IMODE)  ! d d~ > e- e+ c s c~ s~
        IF(IPROC.EQ.39) DSIGPROC=DSIG39(P1,WGT,IMODE)  ! d d~ > e- e+ d d d~ d~
        IF(IPROC.EQ.40) DSIGPROC=DSIG40(P1,WGT,IMODE)  ! d d~ > e- e+ d s d~ s~
      ENDIF
