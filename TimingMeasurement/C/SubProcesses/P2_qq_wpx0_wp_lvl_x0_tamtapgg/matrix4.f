...
C     Amplitude(s) for diagram number 1
      ...
      CALL VVS2_6P0_1(W(1,7),W(1,8),GC_64,GC_10,ZERO, FK_ZERO,W(1,2))
      CALL VVS2_6_3(W(1,2),W(1,6),GC_64,GC_10,MDL_MX0, FK_MDL_WX0,W(1
     $ ,1))
...
C     Amplitude(s) for diagram number 3
      CALL VVS4_0(W(1,9),W(1,5),W(1,2),GC_99,AMP(3))
      CALL VVS2_6_3(W(1,6),W(1,7),GC_64,GC_10,MDL_MX0, FK_MDL_WX0,W(1
     $ ,11))
      CALL SSS1_1(W(1,8),W(1,11),GC_98,MDL_MX0, FK_MDL_WX0,W(1,12))
C     Amplitude(s) for diagram number 4
      CALL VVS4_0(W(1,9),W(1,5),W(1,12),GC_99,AMP(4))
      CALL FFS1_2_1(W(1,4),W(1,11),GC_106,GC_105,MDL_MTA, FK_ZERO,W(1
     $ ,8))
      CALL FFS1_2_3(W(1,3),W(1,8),GC_106,GC_105,MDL_MX0, FK_MDL_WX0
     $ ,W(1,13))
C     Amplitude(s) for diagram number 5
      CALL VVS4_0(W(1,9),W(1,5),W(1,13),GC_99,AMP(5))
      CALL FFS1_2_2(W(1,3),W(1,11),GC_106,GC_105,MDL_MTA, FK_ZERO,W(1
     $ ,8))
...
C     Amplitude(s) for diagram number 7
      CALL VVS4_0(W(1,9),W(1,5),W(1,6),GC_99,AMP(7))
...
C     Amplitude(s) for diagram number 8
      CALL VVS4_0(W(1,9),W(1,5),W(1,8),GC_99,AMP(8))
...
C     JAMPs contributing to orders ALL_ORDERS=1
     ...
     $ -AMP(16))
      ...
      AMP2(1)=AMP2(1)+(AMP(1)+AMP(9))*DCONJG(AMP(1)+AMP(9))
      AMP2(2)=AMP2(2)+(AMP(2)+AMP(10))*DCONJG(AMP(2)+AMP(10))
      AMP2(4)=AMP2(4)+(AMP(4)+AMP(12))*DCONJG(AMP(4)+AMP(12))
      AMP2(5)=AMP2(5)+(AMP(5)+AMP(13))*DCONJG(AMP(5)+AMP(13))
      AMP2(6)=AMP2(6)+(AMP(6)+AMP(14))*DCONJG(AMP(6)+AMP(14))
      AMP2(7)=AMP2(7)+(AMP(7)+AMP(15))*DCONJG(AMP(7)+AMP(15))
      AMP2(8)=AMP2(8)+(AMP(8)+AMP(16))*DCONJG(AMP(8)+AMP(16))
      DO I = 1, NCOLOR
        DO M = 1, NAMPSO
          DO N = 1, NAMPSO
            IF (CHOSEN_SO_CONFIGS(SQSOINDEX4(M,N))) THEN
