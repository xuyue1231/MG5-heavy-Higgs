...
C     ----------
     ...
     $   , ZERO)
      ...
      CALL FFV3_3(W(1,4),W(1,3),GC_72,MDL_MW, FK_MDL_WW,W(1,6))
      CALL OXXXXX(P(0,7),ZERO,NHEL(7),+1*IC(7),W(1,3))
      CALL IXXXXX(P(0,8),ZERO,NHEL(8),-1*IC(8),W(1,4))
      CALL FFV3_3(W(1,4),W(1,3),GC_109,MDL_MW, FK_MDL_WW,W(1,7))
      CALL FFV3_3(W(1,1),W(1,2),GC_109,MDL_MW, FK_MDL_WW,W(1,4))
      CALL VVS4_3(W(1,7),W(1,5),GC_99,MDL_MX0, FK_MDL_WX0,W(1,2))
C     Amplitude(s) for diagram number 1
      CALL VVS4_0(W(1,4),W(1,6),W(1,2),GC_99,AMP(1))
C     Amplitude(s) for diagram number 2
      CALL VVS1_5_6_7_0(W(1,4),W(1,6),W(1,2),GC_67,GC_39,GC_41,GC_111
     $ ,AMP(2))
      CALL VVS1_5_6_7_3(W(1,7),W(1,5),GC_67,GC_39,GC_41,GC_111,MDL_MX0
     $ , FK_MDL_WX0,W(1,2))
C     Amplitude(s) for diagram number 3
      CALL VVS4_0(W(1,4),W(1,6),W(1,2),GC_99,AMP(3))
C     Amplitude(s) for diagram number 4
      CALL VVS1_5_6_7_0(W(1,4),W(1,6),W(1,2),GC_67,GC_39,GC_41,GC_111
     $ ,AMP(4))
      CALL VVS4_3(W(1,7),W(1,6),GC_99,MDL_MX0, FK_MDL_WX0,W(1,2))
C     Amplitude(s) for diagram number 5
      CALL VVS4_0(W(1,4),W(1,5),W(1,2),GC_99,AMP(5))
C     Amplitude(s) for diagram number 6
      CALL VVS1_5_6_7_0(W(1,4),W(1,5),W(1,2),GC_67,GC_39,GC_41,GC_111
     $ ,AMP(6))
      CALL VVS1_5_6_7_3(W(1,7),W(1,6),GC_67,GC_39,GC_41,GC_111,MDL_MX0
     $ , FK_MDL_WX0,W(1,2))
C     Amplitude(s) for diagram number 7
      CALL VVS4_0(W(1,4),W(1,5),W(1,2),GC_99,AMP(7))
...
C     JAMPs contributing to orders ALL_ORDERS=1
     ...
     $ +AMP(2)+AMP(3)+AMP(4))
      AMP2(5)=AMP2(5)+(AMP(5)+AMP(6)+AMP(7)+AMP(8))*DCONJG(AMP(5)
     $ +AMP(6)+AMP(7)+AMP(8))
      DO I = 1, NCOLOR
        DO M = 1, NAMPSO
          DO N = 1, NAMPSO
