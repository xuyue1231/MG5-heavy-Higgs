...
C     
     ...
     $ * W1))
      V1(3)= DENOM*S3(3)*(-CI*(P2(0)*TMP14)+CI*(V2(3)*TMP11))
      V1(4)= DENOM*S3(3)*(-CI*(P2(1)*TMP14)+CI*(V2(4)*TMP11))
      V1(5)= DENOM*S3(3)*(-CI*(P2(2)*TMP14)+CI*(V2(5)*TMP11))
      V1(6)= DENOM*S3(3)*(-CI*(P2(3)*TMP14)+CI*(V2(6)*TMP11))
      END
