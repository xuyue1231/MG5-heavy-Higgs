...
C     
      ...
      P3(2) = -DIMAG(S3(2))
      P3(3) = -DIMAG(S3(1))
      TMP26 = (-1D0)*(P1(0)*(P2(1)*(V2(6)*V1(5)-V2(5)*V1(6))+(P2(2)
...
C     Epsilon(1,2,-1,-2)*P(-2,1)*P(-1,2)
C     
      SUBROUTINE VVS1_5_6_7_3(V1, V2, COUP1, COUP2, COUP3, COUP4, M3,
     $  W3,S3)
      IMPLICIT NONE
      COMPLEX*16 CI
      PARAMETER (CI=(0D0,1D0))
      ...
      DO I = 3, 3
        S3(I) = S3(I) + STMP(I)
      ENDDO
      CALL VVS6_3(V1,V2,COUP3,M3,W3,STMP)
      DO I = 3, 3
        S3(I) = S3(I) + STMP(I)
      ENDDO
...
C     Epsilon(1,2,-1,-2)*P(-2,1)*P(-1,2)
C     
      SUBROUTINE VVS1_5_6_3(V1, V2, COUP1, COUP2, COUP3, M3, W3,S3)
      IMPLICIT NONE
      COMPLEX*16 CI
      PARAMETER (CI=(0D0,1D0))
      COMPLEX*16 V2(*)
