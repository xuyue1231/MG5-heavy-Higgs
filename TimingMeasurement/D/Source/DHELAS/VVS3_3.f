...
C     -(Epsilon(1,2,-1,-2)*P(-2,2)*P(-1,1)) + Epsilon(1,2,-1,-2)*P(-2,1)
C     *P(-1,2)
C     
      ...
      P3(2) = -DIMAG(S3(2))
      P3(3) = -DIMAG(S3(1))
      TMP22 = (-1D0)*(P1(0)*(P2(1)*(V2(5)*V1(6)-V2(6)*V1(5))+(P2(2)
     ...
     $ *V1(3)-V2(3)*V1(4)))))))
      TMP23 = (-1D0)*(P1(0)*(P2(1)*(V2(6)*V1(5)-V2(5)*V1(6))+(P2(2)
...
C     
      ...
      REAL*8 W3
      COMPLEX*16 V1(*)
      CALL VVS3_3(V1,V2,COUP1,M3,W3,S3)
      CALL VVS6_3(V1,V2,COUP2,M3,W3,STMP)
      DO I = 3, 3
        S3(I) = S3(I) + STMP(I)
      ENDDO
      END
...
C     *P(-1,2)
C     
      SUBROUTINE VVS3_6_8_3(V1, V2, COUP1, COUP2, COUP3, M3, W3,S3)
      IMPLICIT NONE
      COMPLEX*16 CI
      PARAMETER (CI=(0D0,1D0))
      COMPLEX*16 V2(*)
      ...
      DO I = 3, 3
        S3(I) = S3(I) + STMP(I)
      ENDDO
      CALL VVS8_3(V1,V2,COUP3,M3,W3,STMP)
      DO I = 3, 3
        S3(I) = S3(I) + STMP(I)
      ENDDO
      END
