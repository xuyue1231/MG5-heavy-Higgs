...
C     
C     Process: d u~ > w- x0 > w- w- w+ QNP<=2 WEIGHTED<=8 @3
...
C     *   Decay: w- > mu- vm~ QNP<=2 WEIGHTED<=2
C     *   Decay: w+ > c s~ QNP<=2 WEIGHTED<=2
C     Process: d c~ > w- x0 > w- w- w+ QNP<=2 WEIGHTED<=8 @3
C     *   Decay: w- > e- ve~ QNP<=2 WEIGHTED<=2
C     *   Decay: w- > e- ve~ QNP<=2 WEIGHTED<=2
C     *   Decay: w+ > u d~ QNP<=2 WEIGHTED<=2
C     Process: d c~ > w- x0 > w- w- w+ QNP<=2 WEIGHTED<=8 @3
...
C     *   Decay: w- > mu- vm~ QNP<=2 WEIGHTED<=2
C     *   Decay: w+ > c s~ QNP<=2 WEIGHTED<=2
C     Process: s u~ > w- x0 > w- w- w+ QNP<=2 WEIGHTED<=8 @3
C     *   Decay: w- > e- ve~ QNP<=2 WEIGHTED<=2
C     *   Decay: w- > e- ve~ QNP<=2 WEIGHTED<=2
C     *   Decay: w+ > u d~ QNP<=2 WEIGHTED<=2
C     Process: s u~ > w- x0 > w- w- w+ QNP<=2 WEIGHTED<=8 @3
...
C     *   Decay: w- > mu- vm~ QNP<=2 WEIGHTED<=2
C     *   Decay: w+ > c s~ QNP<=2 WEIGHTED<=2
C     Process: s c~ > w- x0 > w- w- w+ QNP<=2 WEIGHTED<=8 @3
C     *   Decay: w- > e- ve~ QNP<=2 WEIGHTED<=2
C     *   Decay: w- > e- ve~ QNP<=2 WEIGHTED<=2
C     *   Decay: w+ > u d~ QNP<=2 WEIGHTED<=2
C     Process: s c~ > w- x0 > w- w- w+ QNP<=2 WEIGHTED<=8 @3
...
C       Output weights and number of events
        ...
        DO J=1,SYMCONF(0)
          WRITE(*,'(64E12.4)')((SUMWGT(K,I,J)/SUMPROB,K=1,2),I=1
     $     ,MAXSPROC)
        ENDDO
        SUMPROB=0D0
        DO J=1,SYMCONF(0)
        ...
        DO J=1,SYMCONF(0)
          WRITE(*,'(64E12.4)')((NUMEVTS(K,I,J)/SUMPROB,K=1,2),I=1
     $     ,MAXSPROC)
        ENDDO
        WRITE(*,*)'Events:'
        DO J=1,SYMCONF(0)
          WRITE(*,'(64I12)')((NUMEVTS(K,I,J),K=1,2),I=1,MAXSPROC)
        ENDDO
...
C     
     ...
     $ ,DSIG27,DSIG28,DSIG29,DSIG30,DSIG31,DSIG32
      LOGICAL PASSCUTS
C     
C     LOCAL VARIABLES 
C     
...
C       Flip CM_RAP (to get rapidity right)
      ...
      IF (PASSCUTS(P1)) THEN
        IF(IPROC.EQ.1) DSIGPROC=DSIG1(P1,WGT,IMODE)  ! d u~ > e- ve~ e- ve~ u d~
        IF(IPROC.EQ.2) DSIGPROC=DSIG2(P1,WGT,IMODE)  ! d u~ > e- ve~ e- ve~ u s~
        IF(IPROC.EQ.3) DSIGPROC=DSIG3(P1,WGT,IMODE)  ! d u~ > e- ve~ e- ve~ c d~
        IF(IPROC.EQ.4) DSIGPROC=DSIG4(P1,WGT,IMODE)  ! d u~ > e- ve~ e- ve~ c s~
        IF(IPROC.EQ.5) DSIGPROC=DSIG5(P1,WGT,IMODE)  ! d u~ > e- ve~ mu- vm~ u d~
        IF(IPROC.EQ.6) DSIGPROC=DSIG6(P1,WGT,IMODE)  ! d u~ > e- ve~ mu- vm~ u s~
        IF(IPROC.EQ.7) DSIGPROC=DSIG7(P1,WGT,IMODE)  ! d u~ > e- ve~ mu- vm~ c d~
        IF(IPROC.EQ.8) DSIGPROC=DSIG8(P1,WGT,IMODE)  ! d u~ > e- ve~ mu- vm~ c s~
        IF(IPROC.EQ.9) DSIGPROC=DSIG9(P1,WGT,IMODE)  ! d c~ > e- ve~ e- ve~ u d~
        IF(IPROC.EQ.10) DSIGPROC=DSIG10(P1,WGT,IMODE)  ! d c~ > e- ve~ e- ve~ u s~
        IF(IPROC.EQ.11) DSIGPROC=DSIG11(P1,WGT,IMODE)  ! d c~ > e- ve~ e- ve~ c d~
        IF(IPROC.EQ.12) DSIGPROC=DSIG12(P1,WGT,IMODE)  ! d c~ > e- ve~ e- ve~ c s~
        IF(IPROC.EQ.13) DSIGPROC=DSIG13(P1,WGT,IMODE)  ! d c~ > e- ve~ mu- vm~ u d~
        IF(IPROC.EQ.14) DSIGPROC=DSIG14(P1,WGT,IMODE)  ! d c~ > e- ve~ mu- vm~ u s~
        IF(IPROC.EQ.15) DSIGPROC=DSIG15(P1,WGT,IMODE)  ! d c~ > e- ve~ mu- vm~ c d~
        IF(IPROC.EQ.16) DSIGPROC=DSIG16(P1,WGT,IMODE)  ! d c~ > e- ve~ mu- vm~ c s~
        IF(IPROC.EQ.17) DSIGPROC=DSIG17(P1,WGT,IMODE)  ! s u~ > e- ve~ e- ve~ u d~
        IF(IPROC.EQ.18) DSIGPROC=DSIG18(P1,WGT,IMODE)  ! s u~ > e- ve~ e- ve~ u s~
        IF(IPROC.EQ.19) DSIGPROC=DSIG19(P1,WGT,IMODE)  ! s u~ > e- ve~ e- ve~ c d~
        IF(IPROC.EQ.20) DSIGPROC=DSIG20(P1,WGT,IMODE)  ! s u~ > e- ve~ e- ve~ c s~
        IF(IPROC.EQ.21) DSIGPROC=DSIG21(P1,WGT,IMODE)  ! s u~ > e- ve~ mu- vm~ u d~
        IF(IPROC.EQ.22) DSIGPROC=DSIG22(P1,WGT,IMODE)  ! s u~ > e- ve~ mu- vm~ u s~
        IF(IPROC.EQ.23) DSIGPROC=DSIG23(P1,WGT,IMODE)  ! s u~ > e- ve~ mu- vm~ c d~
        IF(IPROC.EQ.24) DSIGPROC=DSIG24(P1,WGT,IMODE)  ! s u~ > e- ve~ mu- vm~ c s~
        IF(IPROC.EQ.25) DSIGPROC=DSIG25(P1,WGT,IMODE)  ! s c~ > e- ve~ e- ve~ u d~
        IF(IPROC.EQ.26) DSIGPROC=DSIG26(P1,WGT,IMODE)  ! s c~ > e- ve~ e- ve~ u s~
        IF(IPROC.EQ.27) DSIGPROC=DSIG27(P1,WGT,IMODE)  ! s c~ > e- ve~ e- ve~ c d~
        IF(IPROC.EQ.28) DSIGPROC=DSIG28(P1,WGT,IMODE)  ! s c~ > e- ve~ e- ve~ c s~
        IF(IPROC.EQ.29) DSIGPROC=DSIG29(P1,WGT,IMODE)  ! s c~ > e- ve~ mu- vm~ u d~
        IF(IPROC.EQ.30) DSIGPROC=DSIG30(P1,WGT,IMODE)  ! s c~ > e- ve~ mu- vm~ u s~
        IF(IPROC.EQ.31) DSIGPROC=DSIG31(P1,WGT,IMODE)  ! s c~ > e- ve~ mu- vm~ c d~
        IF(IPROC.EQ.32) DSIGPROC=DSIG32(P1,WGT,IMODE)  ! s c~ > e- ve~ mu- vm~ c s~
      ENDIF
