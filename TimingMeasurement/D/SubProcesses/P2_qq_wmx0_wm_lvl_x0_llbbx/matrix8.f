...
C     Amplitude(s) for diagram number 2
      CALL VVS4_0(W(1,5),W(1,9),W(1,8),GC_99,AMP(2))
...
C     Amplitude(s) for diagram number 3
      CALL VVS4_0(W(1,5),W(1,9),W(1,11),GC_99,AMP(3))
...
C     Amplitude(s) for diagram number 7
      CALL VVS4_0(W(1,5),W(1,9),W(1,4),GC_99,AMP(7))
...
C     Amplitude(s) for diagram number 20
      CALL VVS1_5_6_7_0(W(1,5),W(1,9),W(1,4),GC_67,GC_39,GC_41,GC_111
     $ ,AMP(20))
...
C     Amplitude(s) for diagram number 23
      CALL VVS1_5_6_7_0(W(1,5),W(1,9),W(1,7),GC_67,GC_39,GC_41,GC_111
     $ ,AMP(23))
C     Amplitude(s) for diagram number 24
      CALL VVS1_5_6_7_0(W(1,5),W(1,9),W(1,1),GC_67,GC_39,GC_41,GC_111
     $ ,AMP(24))
C     Amplitude(s) for diagram number 25
      CALL VVS1_5_6_7_0(W(1,5),W(1,9),W(1,3),GC_67,GC_39,GC_41,GC_111
     $ ,AMP(25))
