...
C     
     ...
     $ * W1))
      V1(3)= DENOM*(-CI*(V3(3)*TMP12)+CI*(V2(3)*TMP13))
      V1(4)= DENOM*(-CI*(V3(4)*TMP12)+CI*(V2(4)*TMP13))
      V1(5)= DENOM*(-CI*(V3(5)*TMP12)+CI*(V2(5)*TMP13))
      V1(6)= DENOM*(-CI*(V3(6)*TMP12)+CI*(V2(6)*TMP13))
      END
