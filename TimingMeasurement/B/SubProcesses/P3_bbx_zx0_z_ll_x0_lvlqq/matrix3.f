...
C     ----------
     ...
     $   , ZERO)
      ...
      CALL FFV3_3(W(1,7),W(1,6),GC_109,MDL_MW, FK_MDL_WW,W(1,3))
      CALL VVS4_3(W(1,3),W(1,8),GC_99,MDL_MX0, FK_MDL_WX0,W(1,7))
      CALL FFV1P0_3(W(1,1),W(1,2),GC_1,ZERO, FK_ZERO,W(1,6))
C     Amplitude(s) for diagram number 1
      CALL VVS1_5_6_0(W(1,6),W(1,5),W(1,7),GC_66,GC_38,GC_16,AMP(1))
      CALL VVS1_5_6_7_3(W(1,3),W(1,8),GC_67,GC_39,GC_41,GC_111,MDL_MX0
     $ , FK_MDL_WX0,W(1,4))
C     Amplitude(s) for diagram number 2
      CALL VVS1_5_6_0(W(1,6),W(1,5),W(1,4),GC_66,GC_38,GC_16,AMP(2))
      CALL FFV3_4_3(W(1,1),W(1,2),GC_77,GC_89,MDL_MZ, FK_MDL_WZ,W(1,6))
C     Amplitude(s) for diagram number 3
      CALL VVS4_0(W(1,5),W(1,6),W(1,7),GC_100,AMP(3))
C     Amplitude(s) for diagram number 4
      CALL VVS4_0(W(1,5),W(1,6),W(1,4),GC_100,AMP(4))
C     Amplitude(s) for diagram number 5
      CALL VVS3_6_8_0(W(1,5),W(1,6),W(1,7),GC_68,GC_42,GC_40,AMP(5))
C     Amplitude(s) for diagram number 6
      CALL VVS3_6_8_0(W(1,5),W(1,6),W(1,4),GC_68,GC_42,GC_40,AMP(6))
      CALL FFV3_4_2(W(1,1),W(1,5),GC_77,GC_89,MDL_MB, FK_ZERO,W(1,6))
C     Amplitude(s) for diagram number 7
      CALL FFS1_2_0(W(1,6),W(1,2),W(1,7),GC_102,GC_101,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL FFS1_2_0(W(1,6),W(1,2),W(1,4),GC_102,GC_101,AMP(8))
      CALL FFS1_2_2(W(1,1),W(1,7),GC_102,GC_101,MDL_MB, FK_ZERO,W(1,6))
C     Amplitude(s) for diagram number 9
      CALL FFV3_4_0(W(1,6),W(1,2),W(1,5),GC_77,GC_89,AMP(9))
      CALL FFS1_2_2(W(1,1),W(1,4),GC_102,GC_101,MDL_MB, FK_ZERO,W(1,6))
C     Amplitude(s) for diagram number 10
      CALL FFV3_4_0(W(1,6),W(1,2),W(1,5),GC_77,GC_89,AMP(10))
C     JAMPs contributing to orders ALL_ORDERS=1
     ...
     $ +AMP(8)+AMP(9)+AMP(10)
      ...
      AMP2(3)=AMP2(3)+(AMP(3)+AMP(4)+AMP(5)+AMP(6))*DCONJG(AMP(3)
     $ +AMP(4)+AMP(5)+AMP(6))
