...
C     
C     Process: b b~ > z x0 QNP<=2 WEIGHTED<=4 @2
C     *   Decay: z > e- e+ QNP<=2 WEIGHTED<=2
C     *   Decay: x0 > ta- vt~ c s~ QNP<=2 WEIGHTED<=6
C     Process: b b~ > z x0 QNP<=2 WEIGHTED<=4 @2
...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WX0)
      ...
      CALL FFV3_3(W(1,3),W(1,4),GC_72,MDL_MW, FK_MDL_WW,W(1,8))
      CALL FFV3_3(W(1,7),W(1,6),GC_76,MDL_MW, FK_MDL_WW,W(1,9))
      CALL VVS4_3(W(1,8),W(1,9),GC_99,MDL_MX0, FK_MDL_WX0,W(1,7))
      CALL FFV1P0_3(W(1,1),W(1,2),GC_1,ZERO, FK_ZERO,W(1,6))
C     Amplitude(s) for diagram number 1
      CALL VVS1_5_6_0(W(1,6),W(1,5),W(1,7),GC_66,GC_38,GC_16,AMP(1))
      CALL VVS1_5_6_7_3(W(1,8),W(1,9),GC_67,GC_39,GC_41,GC_111,MDL_MX0
     $ , FK_MDL_WX0,W(1,10))
C     Amplitude(s) for diagram number 2
      CALL VVS1_5_6_0(W(1,6),W(1,5),W(1,10),GC_66,GC_38,GC_16,AMP(2))
      CALL FFV3_2(W(1,3),W(1,9),GC_72,MDL_MTA, FK_ZERO,W(1,8))
