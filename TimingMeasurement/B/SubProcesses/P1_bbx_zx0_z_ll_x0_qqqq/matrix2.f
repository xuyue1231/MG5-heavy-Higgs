...
C     ----------
     ...
     $   , ZERO)
      ...
      CALL FFV1P0_3(W(1,7),W(1,3),GC_7,ZERO, FK_ZERO,W(1,6))
      CALL VVS2_6_3(W(1,8),W(1,6),GC_64,GC_10,MDL_MX0, FK_MDL_WX0,W(1
     $ ,7))
...
C     Amplitude(s) for diagram number 2
      CALL VVS4_0(W(1,5),W(1,6),W(1,7),GC_100,AMP(2))
C     Amplitude(s) for diagram number 3
      CALL VVS3_6_8_0(W(1,5),W(1,6),W(1,7),GC_68,GC_42,GC_40,AMP(3))
      CALL FFV3_4_2(W(1,1),W(1,5),GC_77,GC_89,MDL_MB, FK_ZERO,W(1,6))
C     Amplitude(s) for diagram number 4
      CALL FFS1_2_0(W(1,6),W(1,2),W(1,7),GC_102,GC_101,AMP(4))
      CALL FFS1_2_2(W(1,1),W(1,7),GC_102,GC_101,MDL_MB, FK_ZERO,W(1,6))
C     Amplitude(s) for diagram number 5
      CALL FFV3_4_0(W(1,6),W(1,2),W(1,5),GC_77,GC_89,AMP(5))
C     JAMPs contributing to orders ALL_ORDERS=1
      JAMP(1,1)=+1D0/2D0*(-1D0/3D0*AMP(1)-1D0/3D0*AMP(2)-1D0/3D0*AMP(3)
     $ -1D0/3D0*AMP(4)-1D0/3D0*AMP(5))
      JAMP(2,1)=+1D0/2D0*(+AMP(1)+AMP(2)+AMP(3)+AMP(4)+AMP(5))
