...
C     *   Decay: x0 > u u u~ u~ QNP<=2 WEIGHTED<=4
C     Process: b b~ > z x0 QNP<=2 WEIGHTED<=4 @1
C     *   Decay: z > mu- mu+ QNP<=2 WEIGHTED<=2
C     *   Decay: x0 > u u u~ u~ QNP<=2 WEIGHTED<=4
C     Process: b b~ > z x0 QNP<=2 WEIGHTED<=4 @1
C     *   Decay: z > e- e+ QNP<=2 WEIGHTED<=2
C     *   Decay: x0 > c c c~ c~ QNP<=2 WEIGHTED<=4
C     Process: b b~ > z x0 QNP<=2 WEIGHTED<=4 @1
C     *   Decay: z > mu- mu+ QNP<=2 WEIGHTED<=2
C     *   Decay: x0 > c c c~ c~ QNP<=2 WEIGHTED<=4
C     Process: b b~ > z x0 QNP<=2 WEIGHTED<=4 @1
C     *   Decay: z > e- e+ QNP<=2 WEIGHTED<=2
C     *   Decay: x0 > d d d~ d~ QNP<=2 WEIGHTED<=4
C     Process: b b~ > z x0 QNP<=2 WEIGHTED<=4 @1
C     *   Decay: z > mu- mu+ QNP<=2 WEIGHTED<=2
C     *   Decay: x0 > d d d~ d~ QNP<=2 WEIGHTED<=4
C     Process: b b~ > z x0 QNP<=2 WEIGHTED<=4 @1
C     *   Decay: z > e- e+ QNP<=2 WEIGHTED<=2
C     *   Decay: x0 > s s s~ s~ QNP<=2 WEIGHTED<=4
C     Process: b b~ > z x0 QNP<=2 WEIGHTED<=4 @1
C     *   Decay: z > mu- mu+ QNP<=2 WEIGHTED<=2
C     *   Decay: x0 > s s s~ s~ QNP<=2 WEIGHTED<=4
C     
...
C     ----------
     ...
     $   , ZERO)
      ...
      CALL FFV1P0_3(W(1,7),W(1,3),GC_7,ZERO, FK_ZERO,W(1,9))
...
C     Amplitude(s) for diagram number 1
      ...
      CALL FFV1P0_3(W(1,6),W(1,3),GC_7,ZERO, FK_ZERO,W(1,7))
      CALL VVS2_6_3(W(1,8),W(1,7),GC_64,GC_10,MDL_MX0, FK_MDL_WX0,W(1
     $ ,6))
C     Amplitude(s) for diagram number 2
      CALL VVS1_5_6_0(W(1,9),W(1,5),W(1,6),GC_66,GC_38,GC_16,AMP(2))
      CALL FFV3_4_3(W(1,1),W(1,2),GC_77,GC_89,MDL_MZ, FK_MDL_WZ,W(1,9))
C     Amplitude(s) for diagram number 3
      CALL VVS4_0(W(1,5),W(1,9),W(1,10),GC_100,AMP(3))
C     Amplitude(s) for diagram number 4
      CALL VVS4_0(W(1,5),W(1,9),W(1,6),GC_100,AMP(4))
C     Amplitude(s) for diagram number 5
      CALL VVS3_6_8_0(W(1,5),W(1,9),W(1,10),GC_68,GC_42,GC_40,AMP(5))
C     Amplitude(s) for diagram number 6
      CALL VVS3_6_8_0(W(1,5),W(1,9),W(1,6),GC_68,GC_42,GC_40,AMP(6))
      CALL FFV3_4_2(W(1,1),W(1,5),GC_77,GC_89,MDL_MB, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 7
      CALL FFS1_2_0(W(1,9),W(1,2),W(1,10),GC_102,GC_101,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL FFS1_2_0(W(1,9),W(1,2),W(1,6),GC_102,GC_101,AMP(8))
      CALL FFS1_2_2(W(1,1),W(1,10),GC_102,GC_101,MDL_MB, FK_ZERO,W(1,9)
     $ )
C     Amplitude(s) for diagram number 9
      CALL FFV3_4_0(W(1,9),W(1,2),W(1,5),GC_77,GC_89,AMP(9))
      CALL FFS1_2_2(W(1,1),W(1,6),GC_102,GC_101,MDL_MB, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 10
      CALL FFV3_4_0(W(1,9),W(1,2),W(1,5),GC_77,GC_89,AMP(10))
C     JAMPs contributing to orders ALL_ORDERS=1
      JAMP(1,1)=+1D0/2D0*(-1D0/3D0*AMP(1)-AMP(2)-1D0/3D0*AMP(3)-AMP(4)
     $ -1D0/3D0*AMP(5)-AMP(6)-1D0/3D0*AMP(7)-AMP(8)-1D0/3D0*AMP(9)
     $ -AMP(10))
      JAMP(2,1)=+1D0/2D0*(+AMP(1)+1D0/3D0*AMP(2)+AMP(3)+1D0/3D0*AMP(4)
     $ +AMP(5)+1D0/3D0*AMP(6)+AMP(7)+1D0/3D0*AMP(8)+AMP(9)+1D0/3D0
     $ *AMP(10))
