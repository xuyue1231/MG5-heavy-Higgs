...
C     *   Decay: x0 > u u~ b b~ QNP<=2 WEIGHTED<=4
C     Process: b b~ > z x0 QNP<=2 WEIGHTED<=4 @1
C     *   Decay: z > mu- mu+ QNP<=2 WEIGHTED<=2
C     *   Decay: x0 > u u~ b b~ QNP<=2 WEIGHTED<=4
C     Process: b b~ > z x0 QNP<=2 WEIGHTED<=4 @1
C     *   Decay: z > e- e+ QNP<=2 WEIGHTED<=2
C     *   Decay: x0 > c c~ b b~ QNP<=2 WEIGHTED<=4
C     Process: b b~ > z x0 QNP<=2 WEIGHTED<=4 @1
C     *   Decay: z > mu- mu+ QNP<=2 WEIGHTED<=2
C     *   Decay: x0 > c c~ b b~ QNP<=2 WEIGHTED<=4
C     Process: b b~ > z x0 QNP<=2 WEIGHTED<=4 @1
C     *   Decay: z > e- e+ QNP<=2 WEIGHTED<=2
C     *   Decay: x0 > d d~ b b~ QNP<=2 WEIGHTED<=4
C     Process: b b~ > z x0 QNP<=2 WEIGHTED<=4 @1
C     *   Decay: z > mu- mu+ QNP<=2 WEIGHTED<=2
C     *   Decay: x0 > d d~ b b~ QNP<=2 WEIGHTED<=4
C     Process: b b~ > z x0 QNP<=2 WEIGHTED<=4 @1
C     *   Decay: z > e- e+ QNP<=2 WEIGHTED<=2
C     *   Decay: x0 > s s~ b b~ QNP<=2 WEIGHTED<=4
C     Process: b b~ > z x0 QNP<=2 WEIGHTED<=4 @1
C     *   Decay: z > mu- mu+ QNP<=2 WEIGHTED<=2
C     *   Decay: x0 > s s~ b b~ QNP<=2 WEIGHTED<=4
C     
...
C     ----------
     ...
     $   , ZERO)
      ...
      CALL FFV1P0_3(W(1,3),W(1,4),GC_7,ZERO, FK_ZERO,W(1,8))
      CALL FFV1_1(W(1,6),W(1,8),GC_7,MDL_MB, FK_ZERO,W(1,3))
      CALL FFS1_2_3(W(1,7),W(1,3),GC_102,GC_101,MDL_MX0, FK_MDL_WX0
     $ ,W(1,4))
      CALL FFV1P0_3(W(1,1),W(1,2),GC_1,ZERO, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 1
      CALL VVS1_5_6_0(W(1,3),W(1,5),W(1,4),GC_66,GC_38,GC_16,AMP(1))
      CALL FFV1_2(W(1,7),W(1,8),GC_7,MDL_MB, FK_ZERO,W(1,9))
      CALL FFS1_2_3(W(1,9),W(1,6),GC_102,GC_101,MDL_MX0, FK_MDL_WX0
     $ ,W(1,10))
C     Amplitude(s) for diagram number 2
      CALL VVS1_5_6_0(W(1,3),W(1,5),W(1,10),GC_66,GC_38,GC_16,AMP(2))
      CALL FFV1P0_3(W(1,7),W(1,6),GC_7,ZERO, FK_ZERO,W(1,9))
      CALL VVS2_6_3(W(1,8),W(1,9),GC_64,GC_10,MDL_MX0, FK_MDL_WX0,W(1
     $ ,7))
C     Amplitude(s) for diagram number 3
      CALL VVS1_5_6_0(W(1,3),W(1,5),W(1,7),GC_66,GC_38,GC_16,AMP(3))
      CALL FFV3_4_3(W(1,1),W(1,2),GC_77,GC_89,MDL_MZ, FK_MDL_WZ,W(1,3))
C     Amplitude(s) for diagram number 4
      CALL VVS4_0(W(1,5),W(1,3),W(1,4),GC_100,AMP(4))
C     Amplitude(s) for diagram number 5
      CALL VVS4_0(W(1,5),W(1,3),W(1,10),GC_100,AMP(5))
C     Amplitude(s) for diagram number 6
      CALL VVS4_0(W(1,5),W(1,3),W(1,7),GC_100,AMP(6))
C     Amplitude(s) for diagram number 7
      CALL VVS3_6_8_0(W(1,5),W(1,3),W(1,4),GC_68,GC_42,GC_40,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL VVS3_6_8_0(W(1,5),W(1,3),W(1,10),GC_68,GC_42,GC_40,AMP(8))
C     Amplitude(s) for diagram number 9
      CALL VVS3_6_8_0(W(1,5),W(1,3),W(1,7),GC_68,GC_42,GC_40,AMP(9))
      CALL FFV3_4_2(W(1,1),W(1,5),GC_77,GC_89,MDL_MB, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 10
      CALL FFS1_2_0(W(1,3),W(1,2),W(1,4),GC_102,GC_101,AMP(10))
C     Amplitude(s) for diagram number 11
      CALL FFS1_2_0(W(1,3),W(1,2),W(1,10),GC_102,GC_101,AMP(11))
C     Amplitude(s) for diagram number 12
      CALL FFS1_2_0(W(1,3),W(1,2),W(1,7),GC_102,GC_101,AMP(12))
      CALL FFS1_2_2(W(1,1),W(1,4),GC_102,GC_101,MDL_MB, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 13
      CALL FFV3_4_0(W(1,3),W(1,2),W(1,5),GC_77,GC_89,AMP(13))
      CALL FFS1_2_2(W(1,1),W(1,10),GC_102,GC_101,MDL_MB, FK_ZERO,W(1,3)
     $ )
C     Amplitude(s) for diagram number 14
      CALL FFV3_4_0(W(1,3),W(1,2),W(1,5),GC_77,GC_89,AMP(14))
      CALL FFS1_2_2(W(1,1),W(1,7),GC_102,GC_101,MDL_MB, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 15
      CALL FFV3_4_0(W(1,3),W(1,2),W(1,5),GC_77,GC_89,AMP(15))
C     JAMPs contributing to orders ALL_ORDERS=1
     ...
     $ +1D0/3D0*AMP(12)+1D0/3D0*AMP(13)+1D0/3D0*AMP(14)+1D0/3D0*AMP(15)
     $ )
      JAMP(2,1)=+1D0/2D0*(-AMP(1)-AMP(2)-AMP(3)-AMP(4)-AMP(5)-AMP(6)
     ...
     $ -AMP(15))
      ...
      AMP2(4)=AMP2(4)+(AMP(4)+AMP(7))*DCONJG(AMP(4)+AMP(7))
      AMP2(5)=AMP2(5)+(AMP(5)+AMP(8))*DCONJG(AMP(5)+AMP(8))
      AMP2(6)=AMP2(6)+(AMP(6)+AMP(9))*DCONJG(AMP(6)+AMP(9))
