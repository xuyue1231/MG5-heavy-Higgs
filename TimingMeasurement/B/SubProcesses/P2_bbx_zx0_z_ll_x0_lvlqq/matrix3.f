...
C     ----------
     ...
     $   , ZERO)
      ...
      CALL FFV3_3(W(1,7),W(1,6),GC_74,MDL_MW, FK_MDL_WW,W(1,3))
      CALL VVS4_3(W(1,8),W(1,3),GC_99,MDL_MX0, FK_MDL_WX0,W(1,7))
      CALL FFV1P0_3(W(1,1),W(1,2),GC_1,ZERO, FK_ZERO,W(1,6))
C     Amplitude(s) for diagram number 1
      CALL VVS1_5_6_0(W(1,6),W(1,5),W(1,7),GC_66,GC_38,GC_16,AMP(1))
      CALL VVS1_5_6_7_3(W(1,8),W(1,3),GC_67,GC_39,GC_41,GC_111,MDL_MX0
     $ , FK_MDL_WX0,W(1,4))
