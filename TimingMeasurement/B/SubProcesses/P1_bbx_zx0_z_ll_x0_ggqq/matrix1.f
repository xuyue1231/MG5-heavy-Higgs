...
C     *   Decay: x0 > g g u u~ QNP<=2 WEIGHTED<=4
C     Process: b b~ > z x0 QNP<=2 WEIGHTED<=4 @1
C     *   Decay: z > mu- mu+ QNP<=2 WEIGHTED<=2
C     *   Decay: x0 > g g u u~ QNP<=2 WEIGHTED<=4
C     Process: b b~ > z x0 QNP<=2 WEIGHTED<=4 @1
C     *   Decay: z > e- e+ QNP<=2 WEIGHTED<=2
C     *   Decay: x0 > g g c c~ QNP<=2 WEIGHTED<=4
C     Process: b b~ > z x0 QNP<=2 WEIGHTED<=4 @1
C     *   Decay: z > mu- mu+ QNP<=2 WEIGHTED<=2
C     *   Decay: x0 > g g c c~ QNP<=2 WEIGHTED<=4
C     Process: b b~ > z x0 QNP<=2 WEIGHTED<=4 @1
C     *   Decay: z > e- e+ QNP<=2 WEIGHTED<=2
C     *   Decay: x0 > g g d d~ QNP<=2 WEIGHTED<=4
C     Process: b b~ > z x0 QNP<=2 WEIGHTED<=4 @1
C     *   Decay: z > mu- mu+ QNP<=2 WEIGHTED<=2
C     *   Decay: x0 > g g d d~ QNP<=2 WEIGHTED<=4
C     Process: b b~ > z x0 QNP<=2 WEIGHTED<=4 @1
C     *   Decay: z > e- e+ QNP<=2 WEIGHTED<=2
C     *   Decay: x0 > g g s s~ QNP<=2 WEIGHTED<=4
C     Process: b b~ > z x0 QNP<=2 WEIGHTED<=4 @1
C     *   Decay: z > mu- mu+ QNP<=2 WEIGHTED<=2
C     *   Decay: x0 > g g s s~ QNP<=2 WEIGHTED<=4
C     
...
C     ----------
     ...
     $   , ZERO)
      ...
      CALL FFV1P0_3(W(1,7),W(1,6),GC_7,ZERO, FK_ZERO,W(1,9))
      CALL VVS2_6_3(W(1,8),W(1,9),GC_64,GC_10,MDL_MX0, FK_MDL_WX0,W(1
     $ ,10))
      CALL FFV1P0_3(W(1,1),W(1,2),GC_1,ZERO, FK_ZERO,W(1,8))
C     Amplitude(s) for diagram number 1
      CALL VVS1_5_6_0(W(1,8),W(1,5),W(1,10),GC_66,GC_38,GC_16,AMP(1))
      CALL FFV1_1(W(1,6),W(1,4),GC_7,ZERO, FK_ZERO,W(1,11))
      CALL FFV1P0_3(W(1,7),W(1,11),GC_7,ZERO, FK_ZERO,W(1,12))
      CALL VVS2_6_3(W(1,12),W(1,3),GC_64,GC_10,MDL_MX0, FK_MDL_WX0,W(1
     $ ,11))
C     Amplitude(s) for diagram number 2
      CALL VVS1_5_6_0(W(1,8),W(1,5),W(1,11),GC_66,GC_38,GC_16,AMP(2))
      CALL FFV1_2(W(1,7),W(1,4),GC_7,ZERO, FK_ZERO,W(1,12))
      CALL FFV1P0_3(W(1,12),W(1,6),GC_7,ZERO, FK_ZERO,W(1,13))
      CALL VVS2_6_3(W(1,13),W(1,3),GC_64,GC_10,MDL_MX0, FK_MDL_WX0,W(1
     $ ,12))
C     Amplitude(s) for diagram number 3
      CALL VVS1_5_6_0(W(1,8),W(1,5),W(1,12),GC_66,GC_38,GC_16,AMP(3))
      CALL FFV1_1(W(1,6),W(1,3),GC_7,ZERO, FK_ZERO,W(1,13))
      CALL FFV1P0_3(W(1,7),W(1,13),GC_7,ZERO, FK_ZERO,W(1,14))
      CALL VVS2_6_3(W(1,4),W(1,14),GC_64,GC_10,MDL_MX0, FK_MDL_WX0,W(1
     $ ,13))
C     Amplitude(s) for diagram number 4
      CALL VVS1_5_6_0(W(1,8),W(1,5),W(1,13),GC_66,GC_38,GC_16,AMP(4))
      CALL FFV1_2(W(1,7),W(1,3),GC_7,ZERO, FK_ZERO,W(1,14))
      CALL FFV1P0_3(W(1,14),W(1,6),GC_7,ZERO, FK_ZERO,W(1,7))
      CALL VVS2_6_3(W(1,4),W(1,7),GC_64,GC_10,MDL_MX0, FK_MDL_WX0,W(1
     $ ,14))
C     Amplitude(s) for diagram number 5
      CALL VVS1_5_6_0(W(1,8),W(1,5),W(1,14),GC_66,GC_38,GC_16,AMP(5))
      CALL VVV8P0_1(W(1,4),W(1,9),GC_6,ZERO, FK_ZERO,W(1,7))
      CALL VVS2_6_3(W(1,7),W(1,3),GC_64,GC_10,MDL_MX0, FK_MDL_WX0,W(1
     $ ,6))
C     Amplitude(s) for diagram number 6
      CALL VVS1_5_6_0(W(1,8),W(1,5),W(1,6),GC_66,GC_38,GC_16,AMP(6))
      CALL VVV8P0_1(W(1,3),W(1,9),GC_6,ZERO, FK_ZERO,W(1,7))
      CALL VVS2_6_3(W(1,4),W(1,7),GC_64,GC_10,MDL_MX0, FK_MDL_WX0,W(1
     $ ,15))
C     Amplitude(s) for diagram number 7
      CALL VVS1_5_6_0(W(1,8),W(1,5),W(1,15),GC_66,GC_38,GC_16,AMP(7))
      CALL VVVS1_2_4(W(1,4),W(1,3),W(1,9),GC_65,GC_11,MDL_MX0,
     $  FK_MDL_WX0,W(1,7))
C     Amplitude(s) for diagram number 8
      CALL VVS1_5_6_0(W(1,8),W(1,5),W(1,7),GC_66,GC_38,GC_16,AMP(8))
      CALL FFV3_4_3(W(1,1),W(1,2),GC_77,GC_89,MDL_MZ, FK_MDL_WZ,W(1,8))
C     Amplitude(s) for diagram number 9
      CALL VVS4_0(W(1,5),W(1,8),W(1,10),GC_100,AMP(9))
C     Amplitude(s) for diagram number 10
      CALL VVS4_0(W(1,5),W(1,8),W(1,11),GC_100,AMP(10))
C     Amplitude(s) for diagram number 11
      CALL VVS4_0(W(1,5),W(1,8),W(1,12),GC_100,AMP(11))
C     Amplitude(s) for diagram number 12
      CALL VVS4_0(W(1,5),W(1,8),W(1,13),GC_100,AMP(12))
C     Amplitude(s) for diagram number 13
      CALL VVS4_0(W(1,5),W(1,8),W(1,14),GC_100,AMP(13))
C     Amplitude(s) for diagram number 14
      CALL VVS4_0(W(1,5),W(1,8),W(1,6),GC_100,AMP(14))
C     Amplitude(s) for diagram number 15
      CALL VVS4_0(W(1,5),W(1,8),W(1,15),GC_100,AMP(15))
C     Amplitude(s) for diagram number 16
      CALL VVS4_0(W(1,5),W(1,8),W(1,7),GC_100,AMP(16))
C     Amplitude(s) for diagram number 17
      CALL VVS3_6_8_0(W(1,5),W(1,8),W(1,10),GC_68,GC_42,GC_40,AMP(17))
C     Amplitude(s) for diagram number 18
      CALL VVS3_6_8_0(W(1,5),W(1,8),W(1,11),GC_68,GC_42,GC_40,AMP(18))
C     Amplitude(s) for diagram number 19
      CALL VVS3_6_8_0(W(1,5),W(1,8),W(1,12),GC_68,GC_42,GC_40,AMP(19))
C     Amplitude(s) for diagram number 20
      CALL VVS3_6_8_0(W(1,5),W(1,8),W(1,13),GC_68,GC_42,GC_40,AMP(20))
C     Amplitude(s) for diagram number 21
      CALL VVS3_6_8_0(W(1,5),W(1,8),W(1,14),GC_68,GC_42,GC_40,AMP(21))
C     Amplitude(s) for diagram number 22
      CALL VVS3_6_8_0(W(1,5),W(1,8),W(1,6),GC_68,GC_42,GC_40,AMP(22))
C     Amplitude(s) for diagram number 23
      CALL VVS3_6_8_0(W(1,5),W(1,8),W(1,15),GC_68,GC_42,GC_40,AMP(23))
C     Amplitude(s) for diagram number 24
      CALL VVS3_6_8_0(W(1,5),W(1,8),W(1,7),GC_68,GC_42,GC_40,AMP(24))
      CALL FFV3_4_2(W(1,1),W(1,5),GC_77,GC_89,MDL_MB, FK_ZERO,W(1,8))
C     Amplitude(s) for diagram number 25
      CALL FFS1_2_0(W(1,8),W(1,2),W(1,10),GC_102,GC_101,AMP(25))
C     Amplitude(s) for diagram number 26
      CALL FFS1_2_0(W(1,8),W(1,2),W(1,11),GC_102,GC_101,AMP(26))
C     Amplitude(s) for diagram number 27
      CALL FFS1_2_0(W(1,8),W(1,2),W(1,12),GC_102,GC_101,AMP(27))
C     Amplitude(s) for diagram number 28
      CALL FFS1_2_0(W(1,8),W(1,2),W(1,13),GC_102,GC_101,AMP(28))
C     Amplitude(s) for diagram number 29
      CALL FFS1_2_0(W(1,8),W(1,2),W(1,14),GC_102,GC_101,AMP(29))
C     Amplitude(s) for diagram number 30
      CALL FFS1_2_0(W(1,8),W(1,2),W(1,6),GC_102,GC_101,AMP(30))
C     Amplitude(s) for diagram number 31
      CALL FFS1_2_0(W(1,8),W(1,2),W(1,15),GC_102,GC_101,AMP(31))
C     Amplitude(s) for diagram number 32
      CALL FFS1_2_0(W(1,8),W(1,2),W(1,7),GC_102,GC_101,AMP(32))
      CALL FFS1_2_2(W(1,1),W(1,10),GC_102,GC_101,MDL_MB, FK_ZERO,W(1,8)
     $ )
C     Amplitude(s) for diagram number 33
      CALL FFV3_4_0(W(1,8),W(1,2),W(1,5),GC_77,GC_89,AMP(33))
      CALL FFS1_2_2(W(1,1),W(1,11),GC_102,GC_101,MDL_MB, FK_ZERO,W(1,8)
     $ )
C     Amplitude(s) for diagram number 34
      CALL FFV3_4_0(W(1,8),W(1,2),W(1,5),GC_77,GC_89,AMP(34))
      CALL FFS1_2_2(W(1,1),W(1,12),GC_102,GC_101,MDL_MB, FK_ZERO,W(1,8)
     $ )
C     Amplitude(s) for diagram number 35
      CALL FFV3_4_0(W(1,8),W(1,2),W(1,5),GC_77,GC_89,AMP(35))
      CALL FFS1_2_2(W(1,1),W(1,13),GC_102,GC_101,MDL_MB, FK_ZERO,W(1,8)
     $ )
C     Amplitude(s) for diagram number 36
      CALL FFV3_4_0(W(1,8),W(1,2),W(1,5),GC_77,GC_89,AMP(36))
      CALL FFS1_2_2(W(1,1),W(1,14),GC_102,GC_101,MDL_MB, FK_ZERO,W(1,8)
     $ )
C     Amplitude(s) for diagram number 37
      CALL FFV3_4_0(W(1,8),W(1,2),W(1,5),GC_77,GC_89,AMP(37))
      CALL FFS1_2_2(W(1,1),W(1,6),GC_102,GC_101,MDL_MB, FK_ZERO,W(1,8))
C     Amplitude(s) for diagram number 38
      CALL FFV3_4_0(W(1,8),W(1,2),W(1,5),GC_77,GC_89,AMP(38))
      CALL FFS1_2_2(W(1,1),W(1,15),GC_102,GC_101,MDL_MB, FK_ZERO,W(1,8)
     $ )
C     Amplitude(s) for diagram number 39
      CALL FFV3_4_0(W(1,8),W(1,2),W(1,5),GC_77,GC_89,AMP(39))
      CALL FFS1_2_2(W(1,1),W(1,7),GC_102,GC_101,MDL_MB, FK_ZERO,W(1,8))
C     Amplitude(s) for diagram number 40
      CALL FFV3_4_0(W(1,8),W(1,2),W(1,5),GC_77,GC_89,AMP(40))
C     JAMPs contributing to orders ALL_ORDERS=1
      JAMP(1,1)=-IMAG1*AMP(1)+AMP(2)+AMP(5)+IMAG1*AMP(6)-IMAG1*AMP(7)
     $ -IMAG1*AMP(8)-IMAG1*AMP(9)+AMP(10)+AMP(13)+IMAG1*AMP(14)-IMAG1
     $ *AMP(15)-IMAG1*AMP(16)-IMAG1*AMP(17)+AMP(18)+AMP(21)+IMAG1
     $ *AMP(22)-IMAG1*AMP(23)-IMAG1*AMP(24)-IMAG1*AMP(25)+AMP(26)
     $ +AMP(29)+IMAG1*AMP(30)-IMAG1*AMP(31)-IMAG1*AMP(32)-IMAG1*AMP(33)
     $ +AMP(34)+AMP(37)+IMAG1*AMP(38)-IMAG1*AMP(39)-IMAG1*AMP(40)
      JAMP(2,1)=+IMAG1*AMP(1)+AMP(3)+AMP(4)-IMAG1*AMP(6)+IMAG1*AMP(7)
     $ +IMAG1*AMP(8)+IMAG1*AMP(9)+AMP(11)+AMP(12)-IMAG1*AMP(14)+IMAG1
     $ *AMP(15)+IMAG1*AMP(16)+IMAG1*AMP(17)+AMP(19)+AMP(20)-IMAG1
     $ *AMP(22)+IMAG1*AMP(23)+IMAG1*AMP(24)+IMAG1*AMP(25)+AMP(27)
     $ +AMP(28)-IMAG1*AMP(30)+IMAG1*AMP(31)+IMAG1*AMP(32)+IMAG1*AMP(33)
     $ +AMP(35)+AMP(36)-IMAG1*AMP(38)+IMAG1*AMP(39)+IMAG1*AMP(40)
      ...
      AMP2(9)=AMP2(9)+(AMP(9)+AMP(17))*DCONJG(AMP(9)+AMP(17))
      AMP2(10)=AMP2(10)+(AMP(10)+AMP(18))*DCONJG(AMP(10)+AMP(18))
      AMP2(11)=AMP2(11)+(AMP(11)+AMP(19))*DCONJG(AMP(11)+AMP(19))
      AMP2(12)=AMP2(12)+(AMP(12)+AMP(20))*DCONJG(AMP(12)+AMP(20))
      AMP2(13)=AMP2(13)+(AMP(13)+AMP(21))*DCONJG(AMP(13)+AMP(21))
      AMP2(14)=AMP2(14)+(AMP(14)+AMP(22))*DCONJG(AMP(14)+AMP(22))
      AMP2(15)=AMP2(15)+(AMP(15)+AMP(23))*DCONJG(AMP(15)+AMP(23))
