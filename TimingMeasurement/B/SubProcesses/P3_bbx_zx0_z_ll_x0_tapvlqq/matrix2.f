...
C     
C     Process: b b~ > z x0 QNP<=2 WEIGHTED<=4 @3
C     *   Decay: z > e- e+ QNP<=2 WEIGHTED<=2
C     *   Decay: x0 > ta+ vt d c~ QNP<=2 WEIGHTED<=6
C     Process: b b~ > z x0 QNP<=2 WEIGHTED<=4 @3
...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WX0)
      ...
      CALL FFV3_3(W(1,4),W(1,3),GC_72,MDL_MW, FK_MDL_WW,W(1,8))
      CALL FFV3_3(W(1,7),W(1,6),GC_109,MDL_MW, FK_MDL_WW,W(1,9))
      CALL VVS4_3(W(1,9),W(1,8),GC_99,MDL_MX0, FK_MDL_WX0,W(1,7))
      CALL FFV1P0_3(W(1,1),W(1,2),GC_1,ZERO, FK_ZERO,W(1,6))
C     Amplitude(s) for diagram number 1
      CALL VVS1_5_6_0(W(1,6),W(1,5),W(1,7),GC_66,GC_38,GC_16,AMP(1))
      CALL VVS1_5_6_7_3(W(1,9),W(1,8),GC_67,GC_39,GC_41,GC_111,MDL_MX0
     $ , FK_MDL_WX0,W(1,10))
C     Amplitude(s) for diagram number 2
      CALL VVS1_5_6_0(W(1,6),W(1,5),W(1,10),GC_66,GC_38,GC_16,AMP(2))
      CALL FFV3_1(W(1,3),W(1,9),GC_72,MDL_MTA, FK_ZERO,W(1,8))
      CALL FFS1_2_3(W(1,4),W(1,8),GC_106,GC_105,MDL_MX0, FK_MDL_WX0
     $ ,W(1,9))
C     Amplitude(s) for diagram number 3
      CALL VVS1_5_6_0(W(1,6),W(1,5),W(1,9),GC_66,GC_38,GC_16,AMP(3))
      CALL FFV3_4_3(W(1,1),W(1,2),GC_77,GC_89,MDL_MZ, FK_MDL_WZ,W(1,6))
C     Amplitude(s) for diagram number 4
      CALL VVS4_0(W(1,5),W(1,6),W(1,7),GC_100,AMP(4))
C     Amplitude(s) for diagram number 5
      CALL VVS4_0(W(1,5),W(1,6),W(1,10),GC_100,AMP(5))
C     Amplitude(s) for diagram number 6
      CALL VVS4_0(W(1,5),W(1,6),W(1,9),GC_100,AMP(6))
C     Amplitude(s) for diagram number 7
      CALL VVS3_6_8_0(W(1,5),W(1,6),W(1,7),GC_68,GC_42,GC_40,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL VVS3_6_8_0(W(1,5),W(1,6),W(1,10),GC_68,GC_42,GC_40,AMP(8))
C     Amplitude(s) for diagram number 9
      CALL VVS3_6_8_0(W(1,5),W(1,6),W(1,9),GC_68,GC_42,GC_40,AMP(9))
      CALL FFV3_4_2(W(1,1),W(1,5),GC_77,GC_89,MDL_MB, FK_ZERO,W(1,6))
C     Amplitude(s) for diagram number 10
      CALL FFS1_2_0(W(1,6),W(1,2),W(1,7),GC_102,GC_101,AMP(10))
C     Amplitude(s) for diagram number 11
      CALL FFS1_2_0(W(1,6),W(1,2),W(1,10),GC_102,GC_101,AMP(11))
C     Amplitude(s) for diagram number 12
      CALL FFS1_2_0(W(1,6),W(1,2),W(1,9),GC_102,GC_101,AMP(12))
      CALL FFS1_2_2(W(1,1),W(1,7),GC_102,GC_101,MDL_MB, FK_ZERO,W(1,6))
C     Amplitude(s) for diagram number 13
      CALL FFV3_4_0(W(1,6),W(1,2),W(1,5),GC_77,GC_89,AMP(13))
      CALL FFS1_2_2(W(1,1),W(1,10),GC_102,GC_101,MDL_MB, FK_ZERO,W(1,6)
     $ )
C     Amplitude(s) for diagram number 14
      CALL FFV3_4_0(W(1,6),W(1,2),W(1,5),GC_77,GC_89,AMP(14))
      CALL FFS1_2_2(W(1,1),W(1,9),GC_102,GC_101,MDL_MB, FK_ZERO,W(1,6))
C     Amplitude(s) for diagram number 15
      CALL FFV3_4_0(W(1,6),W(1,2),W(1,5),GC_77,GC_89,AMP(15))
C     JAMPs contributing to orders ALL_ORDERS=1
     ...
     $ +AMP(8)+AMP(9)+AMP(10)+AMP(11)+AMP(12)+AMP(13)+AMP(14)+AMP(15)
      ...
      AMP2(4)=AMP2(4)+(AMP(4)+AMP(5)+AMP(7)+AMP(8))*DCONJG(AMP(4)
     $ +AMP(5)+AMP(7)+AMP(8))
