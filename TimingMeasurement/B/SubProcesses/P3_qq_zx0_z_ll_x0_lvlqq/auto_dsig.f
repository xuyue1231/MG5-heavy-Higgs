...
C     
C     Process: u u~ > z x0 QNP<=2 WEIGHTED<=4 @3
C     *   Decay: z > e- e+ QNP<=2 WEIGHTED<=2
C     *   Decay: x0 > e+ ve d u~ QNP<=2 WEIGHTED<=6
C     Process: c c~ > z x0 QNP<=2 WEIGHTED<=4 @3
C     *   Decay: z > e- e+ QNP<=2 WEIGHTED<=2
C     *   Decay: x0 > e+ ve d u~ QNP<=2 WEIGHTED<=6
C     Process: u u~ > z x0 QNP<=2 WEIGHTED<=4 @3
C     *   Decay: z > mu- mu+ QNP<=2 WEIGHTED<=2
C     *   Decay: x0 > mu+ vm d u~ QNP<=2 WEIGHTED<=6
C     Process: c c~ > z x0 QNP<=2 WEIGHTED<=4 @3
C     *   Decay: z > mu- mu+ QNP<=2 WEIGHTED<=2
C     *   Decay: x0 > mu+ vm d u~ QNP<=2 WEIGHTED<=6
C     Process: u u~ > z x0 QNP<=2 WEIGHTED<=4 @3
...
C     Process: u u~ > z x0 QNP<=2 WEIGHTED<=4 @3
C     *   Decay: z > e- e+ QNP<=2 WEIGHTED<=2
C     *   Decay: x0 > e+ ve d c~ QNP<=2 WEIGHTED<=6
C     Process: c c~ > z x0 QNP<=2 WEIGHTED<=4 @3
C     *   Decay: z > e- e+ QNP<=2 WEIGHTED<=2
C     *   Decay: x0 > e+ ve d c~ QNP<=2 WEIGHTED<=6
C     Process: u u~ > z x0 QNP<=2 WEIGHTED<=4 @3
C     *   Decay: z > mu- mu+ QNP<=2 WEIGHTED<=2
C     *   Decay: x0 > mu+ vm d c~ QNP<=2 WEIGHTED<=6
C     Process: c c~ > z x0 QNP<=2 WEIGHTED<=4 @3
C     *   Decay: z > mu- mu+ QNP<=2 WEIGHTED<=2
C     *   Decay: x0 > mu+ vm d c~ QNP<=2 WEIGHTED<=6
C     Process: u u~ > z x0 QNP<=2 WEIGHTED<=4 @3
...
C     Process: u u~ > z x0 QNP<=2 WEIGHTED<=4 @3
C     *   Decay: z > e- e+ QNP<=2 WEIGHTED<=2
C     *   Decay: x0 > e+ ve s u~ QNP<=2 WEIGHTED<=6
C     Process: c c~ > z x0 QNP<=2 WEIGHTED<=4 @3
C     *   Decay: z > e- e+ QNP<=2 WEIGHTED<=2
C     *   Decay: x0 > e+ ve s u~ QNP<=2 WEIGHTED<=6
C     Process: u u~ > z x0 QNP<=2 WEIGHTED<=4 @3
C     *   Decay: z > mu- mu+ QNP<=2 WEIGHTED<=2
C     *   Decay: x0 > mu+ vm s u~ QNP<=2 WEIGHTED<=6
C     Process: c c~ > z x0 QNP<=2 WEIGHTED<=4 @3
C     *   Decay: z > mu- mu+ QNP<=2 WEIGHTED<=2
C     *   Decay: x0 > mu+ vm s u~ QNP<=2 WEIGHTED<=6
C     Process: u u~ > z x0 QNP<=2 WEIGHTED<=4 @3
...
C     Process: u u~ > z x0 QNP<=2 WEIGHTED<=4 @3
C     *   Decay: z > e- e+ QNP<=2 WEIGHTED<=2
C     *   Decay: x0 > e+ ve s c~ QNP<=2 WEIGHTED<=6
C     Process: c c~ > z x0 QNP<=2 WEIGHTED<=4 @3
C     *   Decay: z > e- e+ QNP<=2 WEIGHTED<=2
C     *   Decay: x0 > e+ ve s c~ QNP<=2 WEIGHTED<=6
C     Process: u u~ > z x0 QNP<=2 WEIGHTED<=4 @3
C     *   Decay: z > mu- mu+ QNP<=2 WEIGHTED<=2
C     *   Decay: x0 > mu+ vm s c~ QNP<=2 WEIGHTED<=6
C     Process: c c~ > z x0 QNP<=2 WEIGHTED<=4 @3
C     *   Decay: z > mu- mu+ QNP<=2 WEIGHTED<=2
C     *   Decay: x0 > mu+ vm s c~ QNP<=2 WEIGHTED<=6
C     Process: u u~ > z x0 QNP<=2 WEIGHTED<=4 @3
...
C     *   Decay: z > e- e+ QNP<=2 WEIGHTED<=2
C     *   Decay: x0 > mu+ vm s c~ QNP<=2 WEIGHTED<=6
C     Process: d d~ > z x0 QNP<=2 WEIGHTED<=4 @3
C     *   Decay: z > e- e+ QNP<=2 WEIGHTED<=2
C     *   Decay: x0 > e+ ve d u~ QNP<=2 WEIGHTED<=6
C     Process: s s~ > z x0 QNP<=2 WEIGHTED<=4 @3
C     *   Decay: z > e- e+ QNP<=2 WEIGHTED<=2
C     *   Decay: x0 > e+ ve d u~ QNP<=2 WEIGHTED<=6
C     Process: d d~ > z x0 QNP<=2 WEIGHTED<=4 @3
C     *   Decay: z > mu- mu+ QNP<=2 WEIGHTED<=2
...
C       Flip CM_RAP (to get rapidity right)
      ...
      IF (PASSCUTS(P1)) THEN
        IF(IPROC.EQ.1) DSIGPROC=DSIG1(P1,WGT,IMODE)  ! u u~ > e- e+ e+ ve d u~
        IF(IPROC.EQ.2) DSIGPROC=DSIG2(P1,WGT,IMODE)  ! u u~ > mu- mu+ e+ ve d u~
        IF(IPROC.EQ.3) DSIGPROC=DSIG3(P1,WGT,IMODE)  ! u u~ > e- e+ e+ ve d c~
        IF(IPROC.EQ.4) DSIGPROC=DSIG4(P1,WGT,IMODE)  ! u u~ > mu- mu+ e+ ve d c~
        IF(IPROC.EQ.5) DSIGPROC=DSIG5(P1,WGT,IMODE)  ! u u~ > e- e+ e+ ve s u~
        IF(IPROC.EQ.6) DSIGPROC=DSIG6(P1,WGT,IMODE)  ! u u~ > mu- mu+ e+ ve s u~
        IF(IPROC.EQ.7) DSIGPROC=DSIG7(P1,WGT,IMODE)  ! u u~ > e- e+ e+ ve s c~
        IF(IPROC.EQ.8) DSIGPROC=DSIG8(P1,WGT,IMODE)  ! u u~ > mu- mu+ e+ ve s c~
        IF(IPROC.EQ.9) DSIGPROC=DSIG9(P1,WGT,IMODE)  ! d d~ > e- e+ e+ ve d u~
        IF(IPROC.EQ.10) DSIGPROC=DSIG10(P1,WGT,IMODE)  ! d d~ > mu- mu+ e+ ve d u~
        IF(IPROC.EQ.11) DSIGPROC=DSIG11(P1,WGT,IMODE)  ! d d~ > e- e+ e+ ve d c~
        IF(IPROC.EQ.12) DSIGPROC=DSIG12(P1,WGT,IMODE)  ! d d~ > mu- mu+ e+ ve d c~
        IF(IPROC.EQ.13) DSIGPROC=DSIG13(P1,WGT,IMODE)  ! d d~ > e- e+ e+ ve s u~
        IF(IPROC.EQ.14) DSIGPROC=DSIG14(P1,WGT,IMODE)  ! d d~ > mu- mu+ e+ ve s u~
        IF(IPROC.EQ.15) DSIGPROC=DSIG15(P1,WGT,IMODE)  ! d d~ > e- e+ e+ ve s c~
        IF(IPROC.EQ.16) DSIGPROC=DSIG16(P1,WGT,IMODE)  ! d d~ > mu- mu+ e+ ve s c~
      ENDIF
