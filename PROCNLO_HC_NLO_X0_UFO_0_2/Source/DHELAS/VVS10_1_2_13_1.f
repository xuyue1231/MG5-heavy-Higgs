...
C     
     ...
     $ )))+(COUP4*(P1(0)*(TMP0*(-1D0)*(OM1*TMP7+ 1D0)+OM1*TMP5*TMP8)
     $ +(V2(5)*(TMP3+TMP7)-P2(0)*TMP5))+(V2(5)*(TMP8*COUP3-COUP2)+TMP0
     $ *(P1(0)*OM1*COUP2-P2(0)*COUP3))))
      V1(6)= DENOM*(-CI )* S3(5)*(COUP1*(P1(0)*(P2(2)*V2(8)-P2(3)*V2(7)
     $ )+(P1(2)*(P2(3)*V2(5)-P2(0)*V2(8))+P1(3)*(P2(0)*V2(7)-P2(2)
     $ *V2(5))))+(COUP4*(P1(1)*(TMP0*(OM1*TMP7+ 1D0)-OM1*TMP5*TMP8)
     $ +(V2(6)*(-1D0)*(TMP3+TMP7)+P2(1)*TMP5))+(V2(6)*(COUP2-TMP8
     ...
     $ *V2(6))))+(COUP4*(P1(2)*(TMP0*(OM1*TMP7+ 1D0)-OM1*TMP5*TMP8)
     $ +(V2(7)*(-1D0)*(TMP3+TMP7)+P2(2)*TMP5))+(V2(7)*(COUP2-TMP8
     ...
     $ *V2(5))))+(COUP4*(P1(3)*(TMP0*(OM1*TMP7+ 1D0)-OM1*TMP5*TMP8)
     $ +(V2(8)*(-1D0)*(TMP3+TMP7)+P2(3)*TMP5))+(V2(8)*(COUP2-TMP8
