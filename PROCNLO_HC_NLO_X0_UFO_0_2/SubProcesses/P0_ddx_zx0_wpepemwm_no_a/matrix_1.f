...
C     
C     Process: d d~ > z x0 > w+ e+ e- w- g WEIGHTED<=5 [ all = QCD ] /
C      a
C     Process: s s~ > z x0 > w+ e+ e- w- g WEIGHTED<=5 [ all = QCD ] /
C      a
C     Process: d d~ > z x0 > w+ mu+ mu- w- g WEIGHTED<=5 [ all = QCD ]
C      / a
C     Process: s s~ > z x0 > w+ mu+ mu- w- g WEIGHTED<=5 [ all = QCD ]
C      / a
C     
      IMPLICIT NONE
C     
...
C     ----------
     ...
     $ ,GC_3005H2,GC_3005H3,GC_3005H4,MDL_MX0,MDL_WX0,W(1,9))
      CALL FFV2_4_3(W(1,4),W(1,5),-GC_22,GC_24,MDL_MZ,MDL_WZ,W(1,6))
      CALL FFV2_3_3(W(1,8),W(1,2),-GC_22,GC_23,MDL_MZ,MDL_WZ,W(1,5))
C     Amplitude(s) for diagram number 1
      CALL VVS10_1_2_13_0(W(1,6),W(1,5),W(1,9),GC_3007A,GC_3007H1
...
C     Amplitude(s) for diagram number 2
      CALL VVS10_1_2_13_0(W(1,6),W(1,7),W(1,9),GC_3007A,GC_3007H1
