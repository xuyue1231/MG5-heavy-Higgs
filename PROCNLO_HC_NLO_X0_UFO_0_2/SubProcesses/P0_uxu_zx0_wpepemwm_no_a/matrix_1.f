...
C     
C     Process: u~ u > z x0 > w+ e+ e- w- g WEIGHTED<=5 [ all = QCD ] /
C      a
C     Process: c~ c > z x0 > w+ e+ e- w- g WEIGHTED<=5 [ all = QCD ] /
C      a
C     Process: u~ u > z x0 > w+ mu+ mu- w- g WEIGHTED<=5 [ all = QCD ]
C      / a
C     Process: c~ c > z x0 > w+ mu+ mu- w- g WEIGHTED<=5 [ all = QCD ]
C      / a
C     
      IMPLICIT NONE
C     
