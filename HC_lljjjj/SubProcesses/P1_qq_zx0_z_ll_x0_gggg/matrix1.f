...
C     
C     Process: u u~ > z x0 QNP<=2 WEIGHTED<=4 @1
C     *   Decay: z > e- e+ QNP<=2 WEIGHTED<=2
C     *   Decay: x0 > g g g g QNP<=2 WEIGHTED<=4
C     Process: c c~ > z x0 QNP<=2 WEIGHTED<=4 @1
C     *   Decay: z > e- e+ QNP<=2 WEIGHTED<=2
C     *   Decay: x0 > g g g g QNP<=2 WEIGHTED<=4
C     Process: u u~ > z x0 QNP<=2 WEIGHTED<=4 @1
...
C     ----------
     ...
     $  FK_MDL_WX0,W(1,9))
      CALL FFV1P0_3(W(1,1),W(1,2),GC_2,ZERO, FK_ZERO,W(1,8))
...
C     Amplitude(s) for diagram number 32
      ...
      CALL FFV3_6_3(W(1,1),W(1,2),GC_78,GC_89,MDL_MZ, FK_MDL_WZ,W(1,8))
...
C     JAMPs contributing to orders ALL_ORDERS=1
     ...
     $ -AMP(123)+AMP(121)-AMP(126)+AMP(124))
     ...
     $ +AMP(123)+AMP(122)+AMP(126)+AMP(125))
