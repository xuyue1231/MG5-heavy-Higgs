...
C     
     ...
     $  M3, W3,S3)
      ...
      TMP0 = (-1Q0)*(P1(0)*(P2(1)*(V2(7)*V1(8)-V2(8)*V1(7))+(P2(2)
     ...
     $  W3))
      S3(5)= DENOM*(TMP3*(COUP4*(-1Q0)*(+CI*(TMP4+TMP7))+(-CI*(TMP8
     $ *COUP3)+CI*(COUP2)))+(COUP4*(+CI*(TMP1*TMP2+TMP5*TMP6))+(+CI
     $ *(TMP0*COUP1+TMP1*TMP6*COUP3))))
      END
