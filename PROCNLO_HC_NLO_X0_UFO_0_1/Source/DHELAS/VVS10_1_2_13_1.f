...
C     
      SUBROUTINE VVS10_1_2_13_1(V2, S3, COUP1, COUP2, COUP3, COUP4, M1
     $ , W1,V1)
      IMPLICIT NONE
      COMPLEX*16 CI
     ...
     $ )))+(COUP4*(P1(0)*(TMP1*(-1D0)*(OM1*TMP7+ 1D0)+OM1*TMP5*TMP8)
     $ +(V2(5)*(TMP4+TMP7)-P2(0)*TMP5))+(V2(5)*(TMP8*COUP3-COUP2)+TMP1
     $ *(P1(0)*OM1*COUP2-P2(0)*COUP3))))
      V1(6)= DENOM*(-CI )* S3(5)*(COUP1*(P1(0)*(P2(2)*V2(8)-P2(3)*V2(7)
     $ )+(P1(2)*(P2(3)*V2(5)-P2(0)*V2(8))+P1(3)*(P2(0)*V2(7)-P2(2)
     $ *V2(5))))+(COUP4*(P1(1)*(TMP1*(OM1*TMP7+ 1D0)-OM1*TMP5*TMP8)
     $ +(V2(6)*(-1D0)*(TMP4+TMP7)+P2(1)*TMP5))+(V2(6)*(COUP2-TMP8
     $ *COUP3)+TMP1*(P2(1)*COUP3-P1(1)*OM1*COUP2))))
      V1(7)= DENOM*(-CI )* S3(5)*(COUP1*(P1(0)*(P2(3)*V2(6)-P2(1)*V2(8)
     $ )+(P1(1)*(P2(0)*V2(8)-P2(3)*V2(5))+P1(3)*(P2(1)*V2(5)-P2(0)
     $ *V2(6))))+(COUP4*(P1(2)*(TMP1*(OM1*TMP7+ 1D0)-OM1*TMP5*TMP8)
     $ +(V2(7)*(-1D0)*(TMP4+TMP7)+P2(2)*TMP5))+(V2(7)*(COUP2-TMP8
     $ *COUP3)+TMP1*(P2(2)*COUP3-P1(2)*OM1*COUP2))))
      V1(8)= DENOM*(-CI )* S3(5)*(COUP1*(P1(0)*(P2(1)*V2(7)-P2(2)*V2(6)
     $ )+(P1(1)*(P2(2)*V2(5)-P2(0)*V2(7))+P1(2)*(P2(0)*V2(6)-P2(1)
     $ *V2(5))))+(COUP4*(P1(3)*(TMP1*(OM1*TMP7+ 1D0)-OM1*TMP5*TMP8)
     $ +(V2(8)*(-1D0)*(TMP4+TMP7)+P2(3)*TMP5))+(V2(8)*(COUP2-TMP8
     $ *COUP3)+TMP1*(P2(3)*COUP3-P1(3)*OM1*COUP2))))
      END
