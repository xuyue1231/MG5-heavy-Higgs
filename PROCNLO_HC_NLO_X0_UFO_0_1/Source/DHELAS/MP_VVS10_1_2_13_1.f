...
C     
     ...
     $ )))+(COUP4*(P1(0)*(TMP1*(-1Q0)*(OM1*TMP7+ 1Q0)+OM1*TMP5*TMP8)
     ...
     $ *V2(5))))+(COUP4*(P1(1)*(TMP1*(OM1*TMP7+ 1Q0)-OM1*TMP5*TMP8)
     $ +(V2(6)*(-1Q0)*(TMP4+TMP7)+P2(1)*TMP5))+(V2(6)*(COUP2-TMP8
     ...
     $ *V2(6))))+(COUP4*(P1(2)*(TMP1*(OM1*TMP7+ 1Q0)-OM1*TMP5*TMP8)
     $ +(V2(7)*(-1Q0)*(TMP4+TMP7)+P2(2)*TMP5))+(V2(7)*(COUP2-TMP8
     ...
     $ *V2(5))))+(COUP4*(P1(3)*(TMP1*(OM1*TMP7+ 1Q0)-OM1*TMP5*TMP8)
     $ +(V2(8)*(-1Q0)*(TMP4+TMP7)+P2(3)*TMP5))+(V2(8)*(COUP2-TMP8
