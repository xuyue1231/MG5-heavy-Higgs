...
C     
     ...
     $ )+CI*(V3(8))))))
      COEFF(2,0,1)= COUP*4Q0*(P1(0)*(-1Q0)*(V3(7)+CI*(V3(6)))+(P1(1)*(
     $ -CI*(V3(8))+CI*(V3(5)))+(P1(2)*(V3(5)-V3(8))+P1(3)*(V3(7)+CI
     $ *(V3(6))))))
      COEFF(3,0,1)= COUP*4Q0 * M1*(-CI*(V3(8))+CI*(V3(5)))
      COEFF(4,0,1)= COUP*-4Q0 * M1*(V3(7)+CI*(V3(6)))
      COEFF(1,1,1)= COUP*4Q0*(-CI*(V3(8))+CI*(V3(5)))
      COEFF(2,1,1)= COUP*(-4Q0)*(V3(7)+CI*(V3(6)))
      COEFF(3,1,1)= 0Q0
      COEFF(4,1,1)= 0Q0
      COEFF(1,2,1)= COUP*(-4Q0)*(V3(7)+CI*(V3(6)))
      COEFF(2,2,1)= COUP*4Q0*(-CI*(V3(8))+CI*(V3(5)))
      COEFF(3,2,1)= 0Q0
      COEFF(4,2,1)= 0Q0
      ...
      COEFF(3,3,1)= 0Q0
      COEFF(4,3,1)= 0Q0
      COEFF(1,4,1)= COUP*4Q0*(-CI*(V3(8))+CI*(V3(5)))
      COEFF(2,4,1)= COUP*4Q0*(V3(7)+CI*(V3(6)))
      COEFF(3,4,1)= 0Q0
      COEFF(4,4,1)= 0Q0
      COEFF(1,0,2)= COUP*4Q0*(P1(0)*(V3(7)-CI*(V3(6)))+(P1(1)*(+CI
     ...
     $ +CI*(V3(5)+V3(8))))))
      COEFF(3,0,2)= COUP*4Q0 * M1*(V3(7)-CI*(V3(6)))
      COEFF(4,0,2)= COUP*4Q0 * M1*(+CI*(V3(5)+V3(8)))
      COEFF(1,1,2)= COUP*4Q0*(V3(7)-CI*(V3(6)))
      COEFF(2,1,2)= COUP*4Q0*(+CI*(V3(5)+V3(8)))
      COEFF(3,1,2)= 0Q0
      COEFF(4,1,2)= 0Q0
      COEFF(1,2,2)= COUP*4Q0*(+CI*(V3(5)+V3(8)))
      COEFF(2,2,2)= COUP*4Q0*(V3(7)-CI*(V3(6)))
      COEFF(3,2,2)= 0Q0
      COEFF(4,2,2)= 0Q0
      ...
      COEFF(3,3,2)= 0Q0
      COEFF(4,3,2)= 0Q0
      COEFF(1,4,2)= COUP*4Q0*(V3(7)-CI*(V3(6)))
