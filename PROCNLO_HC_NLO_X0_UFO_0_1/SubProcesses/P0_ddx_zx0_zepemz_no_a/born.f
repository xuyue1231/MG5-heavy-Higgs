...
C     
C     Process: d d~ > z x0 > z e+ e- z WEIGHTED<=4 [ all = QCD ] / a
C     Process: s s~ > z x0 > z e+ e- z WEIGHTED<=4 [ all = QCD ] / a
C     Process: d d~ > z x0 > z mu+ mu- z WEIGHTED<=4 [ all = QCD ] / a
C     Process: s s~ > z x0 > z mu+ mu- z WEIGHTED<=4 [ all = QCD ] / a
C     
      IMPLICIT NONE
C     
C     CONSTANTS
