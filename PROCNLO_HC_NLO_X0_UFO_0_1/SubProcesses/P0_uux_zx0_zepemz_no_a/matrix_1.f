...
C     
C     Process: u u~ > z x0 > z e+ e- z g WEIGHTED<=5 [ all = QCD ] / a
C     Process: c c~ > z x0 > z e+ e- z g WEIGHTED<=5 [ all = QCD ] / a
C     Process: u u~ > z x0 > z mu+ mu- z g WEIGHTED<=5 [ all = QCD ] /
C      a
C     Process: c c~ > z x0 > z mu+ mu- z g WEIGHTED<=5 [ all = QCD ] /
C      a
C     
      IMPLICIT NONE
C     
