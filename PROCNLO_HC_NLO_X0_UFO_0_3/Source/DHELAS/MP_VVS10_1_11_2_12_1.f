...
C     
     ...
     $ )))+(P1(0)*(OM1*(TMP0*(COUP2-TMP8*COUP5)+TMP4*TMP7*COUP5)-TMP0
     $ *COUP3)+(V2(5)*(TMP3*COUP3+TMP4*COUP4+TMP8*COUP5-COUP2)-P2(0)
     $ *(TMP0*COUP4+TMP7*COUP5))))
      V1(6)= DENOM*(-CI )* S3(5)*(COUP1*(P1(0)*(P2(2)*V2(8)-P2(3)*V2(7)
     $ )+(P1(2)*(P2(3)*V2(5)-P2(0)*V2(8))+P1(3)*(P2(0)*V2(7)-P2(2)
     $ *V2(5))))+(P1(1)*(OM1*(TMP0*(TMP8*COUP5-COUP2)-TMP4*TMP7*COUP5)
     $ +TMP0*COUP3)+(V2(6)*(-1Q0)*(TMP3*COUP3+TMP4*COUP4+TMP8*COUP5
     $ -COUP2)+P2(1)*(TMP0*COUP4+TMP7*COUP5))))
      V1(7)= DENOM*(-CI )* S3(5)*(COUP1*(P1(0)*(P2(3)*V2(6)-P2(1)*V2(8)
     $ )+(P1(1)*(P2(0)*V2(8)-P2(3)*V2(5))+P1(3)*(P2(1)*V2(5)-P2(0)
     $ *V2(6))))+(P1(2)*(OM1*(TMP0*(TMP8*COUP5-COUP2)-TMP4*TMP7*COUP5)
     $ +TMP0*COUP3)+(V2(7)*(-1Q0)*(TMP3*COUP3+TMP4*COUP4+TMP8*COUP5
     $ -COUP2)+P2(2)*(TMP0*COUP4+TMP7*COUP5))))
      V1(8)= DENOM*(-CI )* S3(5)*(COUP1*(P1(0)*(P2(1)*V2(7)-P2(2)*V2(6)
     $ )+(P1(1)*(P2(2)*V2(5)-P2(0)*V2(7))+P1(2)*(P2(0)*V2(6)-P2(1)
     $ *V2(5))))+(P1(3)*(OM1*(TMP0*(TMP8*COUP5-COUP2)-TMP4*TMP7*COUP5)
     $ +TMP0*COUP3)+(V2(8)*(-1Q0)*(TMP3*COUP3+TMP4*COUP4+TMP8*COUP5
     $ -COUP2)+P2(3)*(TMP0*COUP4+TMP7*COUP5))))
      END
