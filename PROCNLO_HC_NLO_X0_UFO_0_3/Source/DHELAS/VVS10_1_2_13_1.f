...
C     
     ...
     $ )))+(COUP4*(P1(0)*(TMP0*(-1D0)*(OM1*TMP8+ 1D0)+OM1*TMP4*TMP7)
     ...
     $ *V2(5))))+(COUP4*(P1(1)*(TMP0*(OM1*TMP8+ 1D0)-OM1*TMP4*TMP7)
     $ +(V2(6)*(-1D0)*(TMP3+TMP8)+P2(1)*TMP7))+(V2(6)*(COUP2-TMP4
     ...
     $ *V2(6))))+(COUP4*(P1(2)*(TMP0*(OM1*TMP8+ 1D0)-OM1*TMP4*TMP7)
     $ +(V2(7)*(-1D0)*(TMP3+TMP8)+P2(2)*TMP7))+(V2(7)*(COUP2-TMP4
     ...
     $ *V2(5))))+(COUP4*(P1(3)*(TMP0*(OM1*TMP8+ 1D0)-OM1*TMP4*TMP7)
     $ +(V2(8)*(-1D0)*(TMP3+TMP8)+P2(3)*TMP7))+(V2(8)*(COUP2-TMP4
