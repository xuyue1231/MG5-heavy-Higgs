...
C     
C     Process: u~ d > w- x0 > w- e+ e- z g WEIGHTED<=5 [ all = QCD ] /
C      a
C     Process: c~ s > w- x0 > w- e+ e- z g WEIGHTED<=5 [ all = QCD ] /
C      a
C     Process: u~ d > w- x0 > w- mu+ mu- z g WEIGHTED<=5 [ all = QCD ]
C      / a
C     Process: c~ s > w- x0 > w- mu+ mu- z g WEIGHTED<=5 [ all = QCD ]
C      / a
C     
      IMPLICIT NONE
C     
...
C     Amplitude(s) for diagram number 1
      CALL VVS10_1_11_2_12_0(W(1,3),W(1,5),W(1,8),GC_3005A,GC_3005H1
...
C     Amplitude(s) for diagram number 2
      CALL VVS10_1_11_2_12_0(W(1,3),W(1,7),W(1,8),GC_3005A,GC_3005H1
