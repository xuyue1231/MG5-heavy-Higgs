...
C     
C     Process: u~ d > w- x0 > w- e+ e- z QED<=2 QNP<=2 WEIGHTED<=4 [
C      all = QCD ] / a
C     Process: c~ s > w- x0 > w- e+ e- z QED<=2 QNP<=2 WEIGHTED<=4 [
C      all = QCD ] / a
C     Process: u~ d > w- x0 > w- mu+ mu- z QED<=2 QNP<=2 WEIGHTED<=4 [
C      all = QCD ] / a
C     Process: c~ s > w- x0 > w- mu+ mu- z QED<=2 QNP<=2 WEIGHTED<=4 [
C      all = QCD ] / a
C     
      IMPLICIT NONE
C     
...
C     ----------
      ...
      CALL FFV2_4_3(W(1,4),W(1,5),-GC_22,GC_24,MDL_MZ,MDL_WZ,W(1,2))
      CALL VVS10_1_11_2_12_3(W(1,3),W(1,7),GC_3005A,GC_3005H1
     $ ,GC_3005H2,GC_3005H3,GC_3005H4,MDL_MX0,MDL_WX0,W(1,5))
C     Amplitude(s) for diagram number 1
      CALL VVS10_1_2_13_0(W(1,2),W(1,6),W(1,5),GC_3007A,GC_3007H1
