...
C     
C     Process: d u~ > w- x0 > w- e+ e- z g WEIGHTED<=5 [ all = QCD ] /
C      a
C     Process: s c~ > w- x0 > w- e+ e- z g WEIGHTED<=5 [ all = QCD ] /
C      a
C     Process: d u~ > w- x0 > w- mu+ mu- z g WEIGHTED<=5 [ all = QCD ]
C      / a
C     Process: s c~ > w- x0 > w- mu+ mu- z g WEIGHTED<=5 [ all = QCD ]
C      / a
C     
      IMPLICIT NONE
C     
