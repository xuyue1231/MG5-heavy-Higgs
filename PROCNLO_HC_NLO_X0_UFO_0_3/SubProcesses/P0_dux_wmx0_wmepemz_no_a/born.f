...
C     
C     Process: d u~ > w- x0 > w- e+ e- z WEIGHTED<=4 [ all = QCD ] / a
C     Process: s c~ > w- x0 > w- e+ e- z WEIGHTED<=4 [ all = QCD ] / a
C     Process: d u~ > w- x0 > w- mu+ mu- z WEIGHTED<=4 [ all = QCD ] /
C      a
C     Process: s c~ > w- x0 > w- mu+ mu- z WEIGHTED<=4 [ all = QCD ] /
C      a
C     
      IMPLICIT NONE
C     
