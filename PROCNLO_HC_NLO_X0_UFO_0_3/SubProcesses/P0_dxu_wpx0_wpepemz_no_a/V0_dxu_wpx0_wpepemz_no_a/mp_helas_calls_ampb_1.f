...
C      if true.
      ...
      CALL MP_FFV2_3(W(1,2),W(1,1),GC_47,MDL_MW,MDL_WW,W(1,7))
      CALL MP_FFV2_4_3(W(1,4),W(1,5),-GC_22,GC_24,MDL_MZ,MDL_WZ,W(1,8))
      CALL MP_VVS10_1_11_2_12_3(W(1,7),W(1,3),GC_3005A,GC_3005H1
...
C     Amplitude(s) for born diagram with ID 1
     ...
     $ ,GC_3007H2,GC_3007H3,MDL_MX0,MDL_WX0,W(1,10))
      CALL MP_VVS10_1_11_2_12_1(W(1,3),W(1,10),GC_3005A,GC_3005H1
     $ ,GC_3005H2,GC_3005H3,GC_3005H4,MDL_MW,MDL_WW,W(1,11))
C     Counter-term amplitude(s) for loop diagram number 2
      CALL MP_FFV2_0(W(1,2),W(1,1),W(1,11),R2_DXUW,AMPL(1,1))
