...
C     ----------
      IF (FIRST) THEN
        FIRST=.FALSE.
        FK_MDL_WHH = SIGN(MAX(ABS(MDL_WHH), ABS(MDL_MHH
     $   *SMALL_WIDTH_TREATMENT)), MDL_WHH)
     ...
     $   , ZERO)
      ...
      CALL FFV2_4_3(W(1,4),W(1,3),GC_37,GC_46,MDL_MZ, FK_MDL_WZ,W(1,5))
      ...
      CALL FFV2_3_3(W(1,6),W(1,4),GC_37,GC_45,MDL_MZ, FK_MDL_WZ,W(1,8))
      CALL FFV2_3_3(W(1,7),W(1,3),GC_37,GC_45,MDL_MZ, FK_MDL_WZ,W(1,9))
      CALL VVS2_3_3(W(1,8),W(1,9),GC_18,GC_17,MDL_MHH, FK_MDL_WHH,W(1
     $ ,10))
      CALL FFV2_3_3(W(1,1),W(1,2),GC_37,GC_45,MDL_MZ, FK_MDL_WZ,W(1,11)
     $ )
C     Amplitude(s) for diagram number 1
      CALL VVS2_3_0(W(1,5),W(1,11),W(1,10),GC_18,GC_17,AMP(1))
      CALL VVS1_3(W(1,8),W(1,9),GC_16,MDL_MHH, FK_MDL_WHH,W(1,2))
C     Amplitude(s) for diagram number 2
      CALL VVS2_3_0(W(1,5),W(1,11),W(1,2),GC_18,GC_17,AMP(2))
      CALL FFV2_3_3(W(1,7),W(1,4),GC_37,GC_45,MDL_MZ, FK_MDL_WZ,W(1,9))
      CALL FFV2_3_3(W(1,6),W(1,3),GC_37,GC_45,MDL_MZ, FK_MDL_WZ,W(1,7))
      CALL VVS2_3_3(W(1,9),W(1,7),GC_18,GC_17,MDL_MHH, FK_MDL_WHH,W(1
     $ ,6))
C     Amplitude(s) for diagram number 3
      CALL VVS2_3_0(W(1,5),W(1,11),W(1,6),GC_18,GC_17,AMP(3))
      CALL VVS1_3(W(1,9),W(1,7),GC_16,MDL_MHH, FK_MDL_WHH,W(1,3))
C     Amplitude(s) for diagram number 4
      CALL VVS2_3_0(W(1,5),W(1,11),W(1,3),GC_18,GC_17,AMP(4))
C     Amplitude(s) for diagram number 5
      CALL VVS1_0(W(1,5),W(1,11),W(1,10),GC_16,AMP(5))
C     Amplitude(s) for diagram number 6
      CALL VVS1_0(W(1,5),W(1,11),W(1,2),GC_16,AMP(6))
C     Amplitude(s) for diagram number 7
      CALL VVS1_0(W(1,5),W(1,11),W(1,6),GC_16,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL VVS1_0(W(1,5),W(1,11),W(1,3),GC_16,AMP(8))
C     JAMPs contributing to orders ALL_ORDERS=1
      JAMP(1,1)=+AMP(1)+AMP(2)+AMP(5)+AMP(6)
      JAMP(2,1)=-AMP(3)-AMP(4)-AMP(7)-AMP(8)
      ...
      AMP2(1)=AMP2(1)+(AMP(1)+AMP(2)+AMP(5)+AMP(6))*DCONJG(AMP(1)
     $ +AMP(2)+AMP(5)+AMP(6))
      AMP2(3)=AMP2(3)+(AMP(3)+AMP(4)+AMP(7)+AMP(8))*DCONJG(AMP(3)
     $ +AMP(4)+AMP(7)+AMP(8))
      DO I = 1, NCOLOR
        DO M = 1, NAMPSO
          DO N = 1, NAMPSO
