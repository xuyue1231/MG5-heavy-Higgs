      SUBROUTINE M443_SMATRIXHEL(P,HEL,ANS)
      IMPLICIT NONE
C     
C     CONSTANT
C     
...
C     
      INTEGER USERHEL
      COMMON/M443_HELUSERCHOICE/USERHEL
C     ----------
C     BEGIN CODE
C     ----------
      USERHEL=HEL
      CALL M443_SMATRIX(P,ANS)
      USERHEL=-1

      END

      SUBROUTINE M443_SMATRIX(P,ANS)
C     
...
C     
      ...
      COMMON/M443_BORN_BEAM_POL/POLARIZATIONS
      DATA ((POLARIZATIONS(I,J),I=0,NEXTERNAL),J=0,5)/NPOLENTRIES*-1/

C     
C     FUNCTIONS
C     
      LOGICAL M443_IS_BORN_HEL_SELECTED
...
C      only three external particles.
     ...
     $       -1.AND.(.NOT.M443_IS_BORN_HEL_SELECTED(IHEL))) THEN
              CYCLE
            ENDIF
            T=M443_MATRIX(P ,NHEL(1,IHEL),JC(1))
            IF(POLARIZATIONS(0,0).EQ.-1.OR.M443_IS_BORN_HEL_SELECTED(IH
     $EL)) THEN
              ANS=ANS+T
            ENDIF
      ...
      REAL*8 FUNCTION M443_MATRIX(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.6.6, 2018-06-28
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     ----------
      ...
      CALL FFV2_3(W(1,4),W(1,3),GC_78,MDL_MW,MDL_WW,W(1,5))
      ...
      CALL FFV2_3(W(1,1),W(1,2),GC_33,MDL_MW,MDL_WW,W(1,6))
C     Amplitude(s) for diagram number 1
      CALL VVS2_3_0(W(1,5),W(1,6),W(1,7),GC_15,GC_14,AMP(1))
      CALL VVS1_3(W(1,8),W(1,3),GC_16,MDL_MHH,MDL_WHH,W(1,2))
C     Amplitude(s) for diagram number 2
      CALL VVS2_3_0(W(1,5),W(1,6),W(1,2),GC_15,GC_14,AMP(2))
C     Amplitude(s) for diagram number 3
      CALL VVS1_0(W(1,5),W(1,6),W(1,7),GC_13,AMP(3))
C     Amplitude(s) for diagram number 4
      CALL VVS1_0(W(1,5),W(1,6),W(1,2),GC_13,AMP(4))
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        M443_MATRIX = M443_MATRIX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO

      END

      SUBROUTINE M443_GET_VALUE(P, ALPHAS, NHEL ,ANS)
      IMPLICIT NONE
C     
C     CONSTANT
C     
...
C     the include file with the values of the parameters and masses 
      ...
      SUBROUTINE M443_INITIALISEMODEL(PATH)
C     ROUTINE FOR F2PY to read the benchmark point.    
      IMPLICIT NONE
      CHARACTER*512 PATH
CF2PY INTENT(IN) :: PATH
      ...
      LOGICAL FUNCTION M443_IS_BORN_HEL_SELECTED(HELID)
      IMPLICIT NONE
C     
C     CONSTANTS
C     
...
C     ----------
      ...
      M443_IS_BORN_HEL_SELECTED = .TRUE.
      ...
      DO I=1,NEXTERNAL
        ...
        ENDDO
        IF(.NOT.FOUNDIT) THEN
          M443_IS_BORN_HEL_SELECTED = .FALSE.
          RETURN
        ENDIF
      ENDDO
